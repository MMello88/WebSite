...
var DTPessoasfisica =
function () {
  function DTPessoasfisica() {
    _classCallCheck(this, DTPessoasfisica);
    this.init();
  }

  _createClass(DTPessoasfisica, [{
    key: "init",
    value: function init() {
    ...
    value: function table() {
      return $('#myTablePessoasfisica').DataTable({
        dom: "<'text-muted'Bi>\n        <'table-responsive'tr>\n        <'mt-4'p>",
        buttons: ['copyHtml5', {
          extend: 'print', 
          autoPrint: false
        ...
        columnDefs: [{
          ...
          render: function render(data, type, row, meta) {
            ...
            <div class='custom-control custom-control-nolabel custom-checkbox'>
              <input type='checkbox' class='custom-control-input' name='selectedRow[]' id='p${row['pf_Id']}' value='${row['pf_Id']}'>
              <label class='custom-control-label' for='p${row['pf_Id']}'></label>
            </div>`;
          }
        },{
          targets: 1,
    ...
    value: function clearSelected() {
      ...
      $('#myTablePessoasfisica').on('page.dt', function () {
        self.clearSelectedRows();
      });
