    ...
    class Ref433 extends MY_Controller {
      ...
      public function index(){
        if ($this->session->flashdata('response')){
          ...
          if($this->data['response']['status'] == 'FALSE'){
            $this->data['response']['data'] = $this->sendGet('api/ref433/get', $this->data['login']->data->token, true)->data;
          }
        } else {
          $this->data['response'] = $this->sendGet('api/ref433/get', $this->data['login']->data->token, true);
        }
    
        $this->scripts('assets/javascript/api/ref433/ref433.js');
        $this->load->view('dashboard/template/header', $this->data);
        $this->load->view('api/ref433/GridRef433', $this->data);
        $this->load->view('dashboard/template/footer', $this->data);
      }
    
      public function get(){
        echo json_encode(['data' => $this->sendGet('api/ref433/get', $this->data['login']->data->token)->data]);
      }
      ...
      public function create(){
        ...
        $this->load->view('dashboard/template/header', $this->data);
        $this->load->view('api/ref433/CreateRef433', $this->data);
        $this->load->view('dashboard/template/footer', $this->data);
      }
      ...
      public function edit($Id){
        ...
        if(empty($this->data['response']['data'])){
          ...
          $this->load->view('dashboard/template/header', $this->data);
          $this->load->view('api/ref433/EditRef433', $this->data);
          $this->load->view('dashboard/template/footer', $this->data);
        }
      }
      ...
      public function delete(){
        if($_POST){
          ...
          $response = $this->sendGet('api/ref433/get/'.$Id, $this->data['login']->data->token, true);    
          ...
          if(empty($response['data'])){
            ...
            $response = $this->sendDelete('api/ref433/delete/'.$Id, $this->data['login']->data->token, true);
            $this->session->set_flashdata('response', $response); 
            redirect('ref433');
          }
        }
      ...
      public function view($Id){
        ...
        $this->load->view('dashboard/template/header', $this->data);
        $this->load->view('api/ref433/ViewRef433', $this->data);
        $this->load->view('dashboard/template/footer', $this->data);
      }
    }
