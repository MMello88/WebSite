                      ...
                      <div class='input-group-prepend'>
                        <select id='filterBy' class='custom-select'>
                          <option value='' selected> Filtrar por </option>
													<option value='0'> 431_Id </option>
													<option value='1'> 431_Codigo </option>
													<option value='2'> 431_Descricao </option>
													<option value='3'> 431_DtIni </option>
													<option value='4'> 431_DtFin </option>
