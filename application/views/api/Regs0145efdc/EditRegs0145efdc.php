                    ...
                    <?= form_open(base_url('Regs0145efdc/update/'.$response['data'][0]['0145_Id'])); ?>
                      ...
                      <fieldset>
                        <legend>Alteração do registro</legend> <!-- .form-group -->
							...
							<input type='number' name='0145_CodIncTrib' id='0145_CodIncTrib' class='form-control' placeholder='Código Incidência Tributária' value='<?= $response['data'][0]['0145_CodIncTrib'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='' name='0145_VlRecTot' id='0145_VlRecTot' class='form-control' placeholder='Valor da Receita Bruta Total' value='<?= $response['data'][0]['0145_VlRecTot'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='' name='0145_VlRecAtiv' id='0145_VlRecAtiv' class='form-control' placeholder='Valor da Receita Bruta da Atividade' value='<?= $response['data'][0]['0145_VlRecAtiv'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='' name='0145_VlRecDemaisAtiv' id='0145_VlRecDemaisAtiv' class='form-control' placeholder='Valor da Receita Bruta das demais Atividade' value='<?= $response['data'][0]['0145_VlRecDemaisAtiv'] ?>' required>
							<?php if(isset($response)): ?>
...
<script>
  var url_get = '<?= base_url('regs0145efdc/get'); ?>';
