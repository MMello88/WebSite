                    ...
                    <?= form_open(base_url('Ref439/add')); ?>
                      ...
                      <fieldset>
                        <legend>Adicionar um novo registro</legend> <!-- .form-group -->
							...
							<input type='number' step='0.01' name='439_AliqPis' id='439_AliqPis' class='form-control' placeholder='Alíquota do PIS %' value='<?= isset($response['data']['439_AliqPis']) ? $response['data']['439_AliqPis'] : '' ?>' >
							<?php if(isset($response)): ?>
							...
							<input type='number' step='0.01' name='439_AliqCofins' id='439_AliqCofins' class='form-control' placeholder='Alíquota da COFINS %' value='<?= isset($response['data']['439_AliqCofins']) ? $response['data']['439_AliqCofins'] : '' ?>' >
							<?php if(isset($response)): ?>
