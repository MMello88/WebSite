                    ...
                    <!-- .form -->
                      ...
                      <fieldset>
                        <legend>Alteração do registro</legend> <!-- .form-group -->
							...
							<input type='number' step='0.01' name='4312_AliqPis' id='4312_AliqPis' class='form-control' placeholder='Alíquota do PIS %' value='<?= isset($response['data'][0]['4312_AliqPis']) ? $response['data'][0]['4312_AliqPis'] : '' ?>'  disabled>
							<?php if(isset($response)): ?>
							...
							<input type='number' step='0.01' name='4312_AliqCofins' id='4312_AliqCofins' class='form-control' placeholder='Alíquota da COFINS %' value='<?= isset($response['data'][0]['4312_AliqCofins']) ? $response['data'][0]['4312_AliqCofins'] : '' ?>'  disabled>
							<?php if(isset($response)): ?>
