            ...
            <div class='page-section'>
              ...
              <div class='section-block'>            
                ...
                <div id='base-style' class='card'>
                  ...
                  <div class='card-body'>
                    <!-- .form -->
                    <?= form_open(base_url('Ref4310/update/'.$response['data'][0]['4310_Id'])); ?>
                      <!-- .fieldset -->
                      <fieldset>
                        <legend>Alteração do registro</legend> <!-- .form-group -->
							<div class='form-group'>
								<label for='4310_Codigo'>Código</label>
							<input type='text' name='4310_Codigo' id='4310_Codigo' class='form-control' placeholder='Código' value='<?= $response['data'][0]['4310_Codigo'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='4310_Descricao' id='4310_Descricao' class='form-control' placeholder='Descrição' value='<?= $response['data'][0]['4310_Descricao'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='date' name='4310_DtIni' id='4310_DtIni' class='form-control' placeholder='Data Inicial' value='<?= $response['data'][0]['4310_DtIni'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='date' name='4310_DtFin' id='4310_DtFin' class='form-control' placeholder='Data Final' value='<?= $response['data'][0]['4310_DtFin'] ?>' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='4310_Ncm' id='4310_Ncm' class='form-control' placeholder='NCM' value='<?= $response['data'][0]['4310_Ncm'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='4310_NcmEx' id='4310_NcmEx' class='form-control' placeholder='Exceto NCM' value='<?= $response['data'][0]['4310_NcmEx'] ?>' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='4310_ExIpi' id='4310_ExIpi' class='form-control' placeholder='Código EX TIPI' value='<?= $response['data'][0]['4310_ExIpi'] ?>' >
							<?php if(isset($response)): ?>
							...
							<input type='number' name='4310_AliqPis' id='4310_AliqPis' class='form-control' placeholder='Alíquota do PIS %' value='<?= $response['data'][0]['4310_AliqPis'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='number' name='4310_AliqCofins' id='4310_AliqCofins' class='form-control' placeholder='Alíquota da COFINS %' value='<?= $response['data'][0]['4310_AliqCofins'] ?>' required>
							<?php if(isset($response)): ?>
