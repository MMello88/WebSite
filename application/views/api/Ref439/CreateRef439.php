                    ...
                    <?= form_open(base_url('Ref439/add')); ?>
                      ...
                      <fieldset>
                        <legend>Adicionar um novo registro</legend> <!-- .form-group -->
							...
							<input type='text' name='439_Codigo' id='439_Codigo' class='form-control' placeholder='Código' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='439_Descricao' id='439_Descricao' class='form-control' placeholder='Descrição' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='date' name='439_DtIni' id='439_DtIni' class='form-control' placeholder='Data Inicial' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='date' name='439_DtFin' id='439_DtFin' class='form-control' placeholder='Data Final' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='439_Ncm' id='439_Ncm' class='form-control' placeholder='NCM' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='439_NcmEx' id='439_NcmEx' class='form-control' placeholder='Exceto NCM' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='439_ExIpi' id='439_ExIpi' class='form-control' placeholder='Código EX TIPI' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='number' name='439_AliqPis' id='439_AliqPis' class='form-control' placeholder='Alíquota do PIS %' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='number' name='439_AliqCofins' id='439_AliqCofins' class='form-control' placeholder='Alíquota da COFINS %' value='' >
							<?php if(isset($response)): ?>
...
<script>
  var url_get = '<?= base_url('ref439/create'); ?>';
