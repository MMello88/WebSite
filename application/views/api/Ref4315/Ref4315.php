              ...
              <nav aria-label='breadcrumb'>
                <ol class='breadcrumb'>
                  <li class='breadcrumb-item active'>
                    <a href='#'><i class='breadcrumb-icon fa fa-angle-left mr-2'></i>Operações sem Incidência da Contribuição Social</a>
                  </li>
                </ol>
              </nav><!-- /.breadcrumb -->
              <!-- floating action -->
            ...
            <div class='page-section'>
              ...
              <div class='card card-fluid'>
                ...
                <div class='card-header d-md-flex align-items-md-start'>
                  <h1 class='page-title mr-sm-auto'> Operações sem Incidência da Contribuição Social </h1><!-- .btn-toolbar -->
                      ...
                      <div class='input-group-prepend'>
                        <select id='filterBy' class='custom-select'>
                          <option value='' selected> Filtrar por </option>
													<option value='0'> 4315_Id </option>
													<option value='1'> 4315_Codigo </option>
													<option value='2'> 4315_Descricao </option>
													<option value='3'> 4315_DtIni </option>
													<option value='4'> 4315_DtFin </option>
													<option value='5'> 4315_Ncm </option>
													<option value='6'> 4315_NcmEx </option>
													<option value='7'> 4315_ExIpi </option>
    ...
    <title>Operações sem Incidência da Contribuição Social</title>
<script>
