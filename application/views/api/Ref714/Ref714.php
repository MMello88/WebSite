              ...
              <nav aria-label='breadcrumb'>
                <ol class='breadcrumb'>
                  <li class='breadcrumb-item active'>
                    <a href='#'><i class='breadcrumb-icon fa fa-angle-left mr-2'></i>Detalhamento Analítico das Deduções e Exclusões</a>
                  </li>
                </ol>
              </nav><!-- /.breadcrumb -->
              <!-- floating action -->
            ...
            <div class='page-section'>
              ...
              <div class='card card-fluid'>
                ...
                <div class='card-header d-md-flex align-items-md-start'>
                  <h1 class='page-title mr-sm-auto'> Detalhamento Analítico das Deduções e Exclusões </h1><!-- .btn-toolbar -->
                      ...
                      <div class='input-group-prepend'>
                        <select id='filterBy' class='custom-select'>
                          <option value='' selected> Filtrar por </option>
													<option value='0'> 714_Id </option>
													<option value='1'> 714_Codigo </option>
													<option value='2'> 714_Descricao </option>
													<option value='3'> 714_DtIni </option>
													<option value='4'> 714_DtFin </option>
													<option value='5'> 714_IndTipoAtividade </option>
													<option value='6'> 714_IndAjuste </option>
													<option value='7'> 714_Grupo </option>
													<option value='8'> 714_SubGrupo </option>
													<option value='9'> 714_IndOutros </option>
    ...
    <title>Detalhamento Analítico das Deduções e Exclusões</title>
<script>
