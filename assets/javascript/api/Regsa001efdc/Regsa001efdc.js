...
var DTRegsa001efdc =
function () {
  function DTRegsa001efdc() {
    _classCallCheck(this, DTRegsa001efdc);
    this.init();
  }

  _createClass(DTRegsa001efdc, [{
    key: "init",
    value: function init() {
    ...
    value: function table() {
      return $('#myTableRegsa001efdc').DataTable({
        dom: "<'text-muted'Bi>\n        <'table-responsive'tr>\n        <'mt-4'p>",
        buttons: ['copyHtml5', {
          extend: 'print', 
          autoPrint: false
        ...
        columnDefs: [{
          ...
          render: function render(data, type, row, meta) {
            ...
            <div class='custom-control custom-control-nolabel custom-checkbox'>
              <input type='checkbox' class='custom-control-input' name='selectedRow[]' id='p${row['a001_Id']}' value='${row['a001_Id']}'>
              <label class='custom-control-label' for='p${row['a001_Id']}'></label>
            </div>`;
          }
        },{
          targets: 1,
    ...
    value: function clearSelected() {
      ...
      $('#myTableRegsa001efdc').on('page.dt', function () {
        self.clearSelectedRows();
      });
