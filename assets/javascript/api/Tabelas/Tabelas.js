...
function () {
  function DTTabelas() {
    _classCallCheck(this, DTTabelas);
    this.init();
  }

  _createClass(DTTabelas, [{
    key: "init",
    value: function init() {
    ...
    value: function table() {
      return $('#myTableTabelas').DataTable({
        dom: "<'text-muted'Bi>\n        <'table-responsive'tr>\n        <'mt-4'p>",
        buttons: ['copyHtml5', {
          extend: 'print', 
          autoPrint: false
        ...
        columnDefs: [{
          ...
          render: function render(data, type, row, meta) {
            ...
            <div class='custom-control custom-control-nolabel custom-checkbox'>
              <input type='checkbox' class='custom-control-input' name='selectedRow[]' id='p${row['TABLE_NAME']}' value='${row['TABLE_NAME']}'>
              <label class='custom-control-label' for='p${row['TABLE_NAME']}'></label>
            </div>`;
          }
        },{
          targets: 1,
    ...
    value: function clearSelected() {
      ...
      $('#myTableTabelas').on('page.dt', function () {
        self.clearSelectedRows();
      });
