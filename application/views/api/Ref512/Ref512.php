                      ...
                      <div class='input-group-prepend'>
                        <select id='filterBy' class='custom-select'>
                          <option value='' selected> Filtrar por </option>
													<option value='0'> 512_Id </option>
													<option value='1'> 512_Codigo </option>
													<option value='2'> 512_Descricao </option>
													<option value='3'> 512_DtIni </option>
													<option value='4'> 512_DtFin </option>
