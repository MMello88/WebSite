                    ...
                    <?= form_open(base_url('Regs0600efdc/add')); ?>
                      ...
                      <fieldset>
                        <legend>Adicionar um novo registro</legend> <!-- .form-group -->
							...
							<input type='datetime-local'  name='0600_DtAlteracao' id='0600_DtAlteracao' class='form-control' placeholder='Data Alteração' value='<?= isset($response['data']['0600_DtAlteracao']) ? (substr($response['data']['0600_DtAlteracao'],10,1) !== 'T' ? date_format(date_create_from_format('Y-m-d H:i:s', $response['data']['0600_DtAlteracao']),'Y-m-d\TH:i') : $response['data']['0600_DtAlteracao']) : '' ?>' required>
							<?php if(isset($response)): ?>
