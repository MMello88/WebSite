            ...
            <div class='page-section'>
              ...
              <div class='section-block'>            
                ...
                <div id='base-style' class='card'>
                  ...
                  <div class='card-body'>
                    <!-- .form -->
                    <?= form_open(base_url('Regs0500efdc/update/'.$response['data'][0]['0500_Id'])); ?>
                      <!-- .fieldset -->
                      <fieldset>
                        <legend>Alteração do registro</legend> <!-- .form-group -->
							...
							<select name='0500_CodNatCC' id='0500_CodNatCC' class='custom-select' placeholder='Código Natureza Conta' required>
								...
								<option value='01 - Contas de ativo' <?= $response['data'][0]['0500_CodNatCC'] == '01 - Contas de ativo' ? 'selected' : '' ?>> 01 - Contas de ativo </option>
								<option value='02 - Contas de passivo' <?= $response['data'][0]['0500_CodNatCC'] == '02 - Contas de passivo' ? 'selected' : '' ?>> 02 - Contas de passivo </option>
								<option value='03 - Patrimônio líquido' <?= $response['data'][0]['0500_CodNatCC'] == '03 - Patrimônio líquido' ? 'selected' : '' ?>> 03 - Patrimônio líquido </option>
								<option value='04 - Contas de resultado' <?= $response['data'][0]['0500_CodNatCC'] == '04 - Contas de resultado' ? 'selected' : '' ?>> 04 - Contas de resultado </option>
								<option value='05 - Contas de compensação' <?= $response['data'][0]['0500_CodNatCC'] == '05 - Contas de compensação' ? 'selected' : '' ?>> 05 - Contas de compensação </option>
								<option value='09 - Outras' <?= $response['data'][0]['0500_CodNatCC'] == '09 - Outras' ? 'selected' : '' ?>> 09 - Outras </option>
							</select>
						</div>
							<div class='form-group'>
							...
							<input type='number' name='0500_PessoaJuridicaId' id='0500_PessoaJuridicaId' class='form-control' placeholder='Pessoa Juridica' value='<?= $response['data'][0]['0500_PessoaJuridicaId'] ?>' >
							<?php if(isset($response)): ?>
