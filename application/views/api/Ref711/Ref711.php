              ...
              <nav aria-label='breadcrumb'>
                <ol class='breadcrumb'>
                  <li class='breadcrumb-item active'>
                    <a href='#'><i class='breadcrumb-icon fa fa-angle-left mr-2'></i>Composição das Receitas</a>
                  </li>
                </ol>
              </nav><!-- /.breadcrumb -->
              <!-- floating action -->
            ...
            <div class='page-section'>
              ...
              <div class='card card-fluid'>
                ...
                <div class='card-header d-md-flex align-items-md-start'>
                  <h1 class='page-title mr-sm-auto'> Composição das Receitas </h1><!-- .btn-toolbar -->
                      ...
                      <div class='input-group-prepend'>
                        <select id='filterBy' class='custom-select'>
                          <option value='' selected> Filtrar por </option>
													<option value='0'> 711_Id </option>
													<option value='1'> 711_Codigo </option>
													<option value='2'> 711_Descricao </option>
													<option value='3'> 711_DtIni </option>
													<option value='4'> 711_DtFin </option>
													<option value='5'> 711_IndTipoAtividade </option>
													<option value='6'> 711_IndAjuste </option>
													<option value='7'> 711_Grupo </option>
													<option value='8'> 711_IndOutros </option>
    ...
    <title>Composição das Receitas</title>
<script>
