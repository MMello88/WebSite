...
function () {
  function DTRef434() {
    _classCallCheck(this, DTRef434);
    this.init();
  }

  _createClass(DTRef434, [{
    key: "init",
    value: function init() {
    ...
    value: function table() {
      return $('#myTableRef434').DataTable({
        dom: "<'text-muted'Bi>\n        <'table-responsive'tr>\n        <'mt-4'p>",
        buttons: ['copyHtml5', {
          extend: 'print', 
          autoPrint: false
        ...
        columnDefs: [{
          ...
          render: function render(data, type, row, meta) {
            ...
            <div class='custom-control custom-control-nolabel custom-checkbox'>
              <input type='checkbox' class='custom-control-input' name='selectedRow[]' id='p${row['434_Id']}' value='${row['434_Id']}'>
              <label class='custom-control-label' for='p${row['434_Id']}'></label>
            </div>`;
          }
        },{
          targets: 1,
    ...
    value: function clearSelected() {
      ...
      $('#myTableRef434').on('page.dt', function () {
        self.clearSelectedRows();
      });
