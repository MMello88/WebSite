                      ...
                      <div class='input-group-prepend'>
                        <select id='filterBy' class='custom-select'>
                          <option value='' selected> Filtrar por </option>
													<option value='0'> 311_Id </option>
													<option value='1'> 311_Codigo </option>
													<option value='2'> 311_Versao </option>
													<option value='3'> 311_Leiaout </option>
													<option value='4'> 311_DtIni </option>
													<option value='5'> 311_DtFin </option>
