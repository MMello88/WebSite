            ...
            <div class='page-section'>
              ...
              <div class='section-block'>            
                ...
                <div id='base-style' class='card'>
                  ...
                  <div class='card-body'>
                    <!-- .form -->
                    <?= form_open(base_url('Ref411/add')); ?>
                      <!-- .fieldset -->
                      <fieldset>
                        <legend>Adicionar um novo registro</legend> <!-- .form-group -->
							<div class='form-group'>
								<label for='411_Codigo'>Código</label>
							<input type='text' name='411_Codigo' id='411_Codigo' class='form-control' placeholder='Código' value='<?= isset($response['data']['411_Codigo']) ? $response['data']['411_Codigo'] : '' ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='411_Descricao' id='411_Descricao' class='form-control' placeholder='Descrição' value='<?= isset($response['data']['411_Descricao']) ? $response['data']['411_Descricao'] : '' ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='411_Modelo' id='411_Modelo' class='form-control' placeholder='Modelo' value='<?= isset($response['data']['411_Modelo']) ? $response['data']['411_Modelo'] : '' ?>' >
							<?php if(isset($response)): ?>
							...
							<input type='date' name='411_DtIni' id='411_DtIni' class='form-control' placeholder='Data Inicial' value='<?= isset($response['data']['411_DtIni']) ? $response['data']['411_DtIni'] : '' ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='date' name='411_DtFin' id='411_DtFin' class='form-control' placeholder='Data Final' value='<?= isset($response['data']['411_DtFin']) ? $response['data']['411_DtFin'] : '' ?>' >
							<?php if(isset($response)): ?>
...
<script>
  var url_get = '<?= base_url('ref411/create'); ?>';
