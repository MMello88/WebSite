                      ...
                      <div class='input-group-prepend'>
                        <select id='filterBy' class='custom-select'>
                          <option value='' selected> Filtrar por </option>
													<option value='0'> 438_Id </option>
													<option value='1'> 438_Codigo </option>
													<option value='2'> 438_Descricao </option>
													<option value='3'> 438_DtIni </option>
													<option value='4'> 438_DtFin </option>
