                    ...
                    <?= form_open(base_url('Pessoasjuridica/add')); ?>
                      ...
                      <fieldset>
                        <legend>Adicionar um novo registro</legend> <!-- .form-group -->
							...
							<input type='text' name='pj_Nome' id='pj_Nome' class='form-control' placeholder='Nome' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='pj_NomeFantasia' id='pj_NomeFantasia' class='form-control' placeholder='Nome Fantasia' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='number' name='pj_Matriz' id='pj_Matriz' class='form-control' placeholder='Matriz' value='0' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='pj_Endereco' id='pj_Endereco' class='form-control' placeholder='Endereço' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='pj_Numero' id='pj_Numero' class='form-control' placeholder='Numero' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='pj_Complemento' id='pj_Complemento' class='form-control' placeholder='Complemento' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='pj_Bairro' id='pj_Bairro' class='form-control' placeholder='Bairro' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='pj_CEP' id='pj_CEP' class='form-control' placeholder='Cep' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='pj_Telefone' id='pj_Telefone' class='form-control' placeholder='Telefone' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='pj_Celular' id='pj_Celular' class='form-control' placeholder='Celular' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='pj_Email' id='pj_Email' class='form-control' placeholder='E-mail' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='pj_InscricaoEstadual' id='pj_InscricaoEstadual' class='form-control' placeholder='Inscrição Estadual' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='pj_Cnpj' id='pj_Cnpj' class='form-control' placeholder='CNPJ' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='pj_CNAE' id='pj_CNAE' class='form-control' placeholder='CNAE' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='pj_InscricaoMunicipal' id='pj_InscricaoMunicipal' class='form-control' placeholder='Inscrição Municipal' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='pj_NrSuframa' id='pj_NrSuframa' class='form-control' placeholder='Numero Suframa' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='number' name='pj_NaturezaJuridica' id='pj_NaturezaJuridica' class='form-control' placeholder='Natureza Juridica' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='pj_NomeContato' id='pj_NomeContato' class='form-control' placeholder='Nome do Contato' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='pj_WebSite' id='pj_WebSite' class='form-control' placeholder='Web Site' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='number' name='pj_DmContribuicao' id='pj_DmContribuicao' class='form-control' placeholder='Contribuinte' value='0' required>
							<?php if(isset($response)): ?>
							...
							<input type='number' name='pj_MunicipioId' id='pj_MunicipioId' class='form-control' placeholder='Municipio' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='number' name='pj_PessoaFisicaId' id='pj_PessoaFisicaId' class='form-control' placeholder='Pessoa Fisica' value='' required>
							<?php if(isset($response)): ?>
