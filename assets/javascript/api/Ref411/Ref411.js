...
function () {
  function DTRef411() {
    _classCallCheck(this, DTRef411);
    this.init();
  }

  _createClass(DTRef411, [{
    key: "init",
    value: function init() {
    ...
    value: function table() {
      return $('#myTableRef411').DataTable({
        dom: "<'text-muted'Bi>\n        <'table-responsive'tr>\n        <'mt-4'p>",
        buttons: ['copyHtml5', {
          extend: 'print', 
          autoPrint: false
        ...
        columnDefs: [{
          ...
          render: function render(data, type, row, meta) {
            ...
            <div class='custom-control custom-control-nolabel custom-checkbox'>
              <input type='checkbox' class='custom-control-input' name='selectedRow[]' id='p${row['411_Id']}' value='${row['411_Id']}'>
              <label class='custom-control-label' for='p${row['411_Id']}'></label>
            </div>`;
          }
        },{
          targets: 1,
    ...
    value: function clearSelected() {
      ...
      $('#myTableRef411').on('page.dt', function () {
        self.clearSelectedRows();
      });
