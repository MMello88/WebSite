                    ...
                    <?= form_open(base_url('Ref4312/update/'.$response['data'][0]['4312_Id'])); ?>
                      ...
                      <fieldset>
                        <legend>Alteração do registro</legend> <!-- .form-group -->
							...
							<input type='number' name='4312_AliqPis' id='4312_AliqPis' class='form-control' placeholder='Alíquota do PIS %' value='<?= $response['data'][0]['4312_AliqPis'] ?>' >
							<?php if(isset($response)): ?>
							...
							<input type='number' name='4312_AliqCofins' id='4312_AliqCofins' class='form-control' placeholder='Alíquota da COFINS %' value='<?= $response['data'][0]['4312_AliqCofins'] ?>' >
							<?php if(isset($response)): ?>
