                      ...
                      <div class='input-group-prepend'>
                        <select id='filterBy' class='custom-select'>
                          <option value='' selected> Filtrar por </option>
													<option value='0'> 4314_Id </option>
													<option value='1'> 4314_Codigo </option>
													<option value='2'> 4314_Descricao </option>
													<option value='3'> 4314_DtIni </option>
													<option value='4'> 4314_DtFin </option>
													<option value='5'> 4314_Ncm </option>
													<option value='6'> 4314_NcmEx </option>
													<option value='7'> 4314_ExIpi </option>
