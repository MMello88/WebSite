            ...
            <div class='page-section'>
              ...
              <div class='section-block'>            
                ...
                <div id='base-style' class='card'>
                  ...
                  <div class='card-body'>
                    <!-- .form -->
                    <?= form_open(base_url('Regs0206efdc/add')); ?>
                      <!-- .fieldset -->
                      <fieldset>
                        <legend>Adicionar um novo registro</legend> <!-- .form-group -->
							<div class='form-group'>
								<label for='0206_Reg'>Registro</label>
							<input type='text' name='0206_Reg' id='0206_Reg' class='form-control' placeholder='Registro' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='0206_CodComb' id='0206_CodComb' class='form-control' placeholder='Código Combustível' value='' required>
							<?php if(isset($response)): ?>
...
<script>
  var url_get = '<?= base_url('regs0206efdc/create'); ?>';
