...
var DTGrupousers =
function () {
  function DTGrupousers() {
    _classCallCheck(this, DTGrupousers);
    this.init();
  }

  _createClass(DTGrupousers, [{
    key: "init",
    value: function init() {
    ...
    value: function table() {
      return $('#myTableGrupousers').DataTable({
        dom: "<'text-muted'Bi>\n        <'table-responsive'tr>\n        <'mt-4'p>",
        buttons: ['copyHtml5', {
          extend: 'print', 
          autoPrint: false
        ...
        columnDefs: [{
          ...
          render: function render(data, type, row, meta) {
            ...
            <div class='custom-control custom-control-nolabel custom-checkbox'>
              <input type='checkbox' class='custom-control-input' name='selectedRow[]' id='p${row['gpu_Id']}' value='${row['gpu_Id']}'>
              <label class='custom-control-label' for='p${row['gpu_Id']}'></label>
            </div>`;
          }
        },{
          targets: 1,
    ...
    value: function clearSelected() {
      ...
      $('#myTableGrupousers').on('page.dt', function () {
        self.clearSelectedRows();
      });
