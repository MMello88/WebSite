                      ...
                      <div class='input-group-prepend'>
                        <select id='filterBy' class='custom-select'>
                          <option value='' selected> Filtrar por </option>
													<option value='0'> 435_Id </option>
													<option value='1'> 435_Codigo </option>
													<option value='2'> 435_Descricao </option>
													<option value='3'> 435_DtIni </option>
													<option value='4'> 435_DtFin </option>
