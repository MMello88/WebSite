...
function () {
  function DTMenus() {
    _classCallCheck(this, DTMenus);
    this.init();
  }

  _createClass(DTMenus, [{
    key: "init",
    value: function init() {
        ...
        columnDefs: [{
          ...
          render: function render(data, type, row, meta) {
            ...
            <div class='custom-control custom-control-nolabel custom-checkbox'>
              <input type='checkbox' class='custom-control-input' name='selectedRow[]' id='p${row['mns_Id']}' value='${row['mns_Id']}'>
              <label class='custom-control-label' for='p${row['mns_Id']}'></label>
            </div>`;
          }
        },{
          targets: 1,
    ...
    value: function clearSelected() {
      ...
      $('#myTableMenus').on('page.dt', function () {
        self.clearSelectedRows();
      });
