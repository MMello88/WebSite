    ...
    class Regs0000efdc extends MY_Controller {
      ...
      public function add(){
        if($_POST){
          ...
          if($response['status'] == 'FALSE'){
            ...
            $salvarEVoltar ? redirect('regs0000efdc') : redirect('regs0000efdc/edit/'.$response['data'][0]['0000_Id']);
          }
        }
      }
      ...
      public function update($Id){
        if($_POST){
          ...
          if($response['status'] == 'FALSE'){
            ...
            $salvarEVoltar ? redirect('regs0000efdc') : redirect('regs0000efdc/edit/'.$Id);
          }
        }
      }
      ...
      public function delete(){
        if($_POST){
          ...
          $response = $this->sendGet('api/regs0000efdc/get/'.$Id, $this->data['login']->data->token, true);    
