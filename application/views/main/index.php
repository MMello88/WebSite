...
<html lang="en">
  ...
  <body>
        ...
        <div class="container">
          ...
          <div class="navbar-collapse collapse" id="navbarTogglerDemo01">
            <ul class="navbar-nav mx-auto">
              ...
              <?php else: ?>
              <li class="nav-item mr-lg-3">
                <a href="<?= base_url('dashboard/index') ?>" class="nav-link py-2">Dashboard <?= $login->data->uu_Nome ?></a>
              </li>
              <li class="nav-item mr-lg-3">
        ...
        <div class="container container-fluid-xl">
          ...
          <div class="row align-items-center">
            ...
            <div class="col-12 col-md-6 order-md-2" data-aos="fade-left">
              <img class="img-fluid img-float-md-6 mb-5 mb-md-0" src="<?= base_url('assets/images/illustration/launch.svg') ?>" alt="">
            </div><!-- /.col-md-6 -->
            <!-- .col-md-6 -->
        ...
        <div class="container">
          ...
          <div class="row text-center text-md-left">
            ...
            <div class="col-6 col-md-3 py-4" data-aos="fade-up" data-aos-delay="0">
              <img class="mb-4" src="<?= base_url('assets/images/illustration/lab.svg') ?>" alt="" height="72">
              <h2 class="lead"> Simple and Rich </h2>
            </div><!-- /.col -->
            <!-- .col -->
            <div class="col-6 col-md-3 py-4" data-aos="fade-up" data-aos-delay="100">
              <img class="mb-4" src="<?= base_url('assets/images/illustration/easy-config.svg') ?>" alt="" height="72">
              <h2 class="lead"> Easy Cuztomizable </h2>
            </div><!-- /.col -->
            <!-- .col -->
            <div class="col-6 col-md-3 py-4" data-aos="fade-up" data-aos-delay="200">
              <img class="mb-4" src="<?= base_url('assets/images/illustration/scale.svg') ?>" alt="" height="72">
              <h2 class="lead"> Fast and scalable </h2>
            </div><!-- /.col -->
            <!-- .col -->
            <div class="col-6 col-md-3 py-4" data-aos="fade-up" data-aos-delay="300">
              <img class="mb-4" src="<?= base_url('assets/images/illustration/support.svg') ?>" alt="" height="72">
        ...
        <div class="container">
          ...
          <div class="row align-items-center">
            ...
            <div class="col-12 col-md-6" data-aos="fade-right">
              <img class="img-fluid mb-4 mb-md-0" src="<?= base_url('assets/images/illustration/solution.svg') ?>" alt="">
            </div><!-- /.col-md-6 -->
            <!-- .col-md-6 -->
      ...
      <section class="pt-5">
        ...
        <div class="container">
          ...
          <div class="row align-items-center">
            <!-- .col-md-6 -->
            <div class="col-12 col-md-6 order-md-2" data-aos="fade-left">
              <img class="img-fluid mb-4 mb-md-0" src="<?= base_url('assets/images/illustration/testimony.svg') ?>" alt="">
            </div><!-- /.col-md-6 -->
            <!-- .col-md-6 -->
      ...
      <section class="position-relative pb-5 bg-light">
        ...
        <div class="sticker">
          <div class="sticker-item sticker-top-right sticker-soften">
            <img src="<?= base_url('assets/images/decoration/cubes.svg') ?>" alt="" data-aos="zoom-in">
          </div>
        ...
        <div class="container position-relative">
          ...
          <div class="card-deck-lg">
            ...
            <div class="card shadow" data-aos="fade-up" data-aos-delay="0">
              ...
              <div class="card-body p-4">
                <div class="d-sm-flex align-items-start text-center text-sm-left">
                  <img src="<?= base_url('assets/images/illustration/rocket.svg') ?>" class="mr-sm-4 mb-3 mb-sm-0" alt="" width="72">
                  <div class="flex-fill">
            ...
            <div class="card shadow" data-aos="fade-up" data-aos-delay="100">
              ...
              <div class="card-body p-4">
                <div class="d-sm-flex align-items-start text-center text-sm-left">
                  <img src="<?= base_url('assets/images/illustration/setting.svg') ?>" class="mr-sm-4 mb-3 mb-sm-0" alt="" width="72">
                  <div class="flex-fill">
          ...
          <div class="card-deck-lg">
            ...
            <div class="card shadow" data-aos="fade-up" data-aos-delay="200">
              ...
              <div class="card-body p-4">
                <div class="d-sm-flex align-items-start text-center text-sm-left">
                  <img src="<?= base_url('assets/images/illustration/brain.svg') ?>" class="mr-sm-4 mb-3 mb-sm-0" alt="" width="72">
                  <div class="flex-fill">
            ...
            <div class="card shadow" data-aos="fade-up" data-aos-delay="300">
              ...
              <div class="card-body p-4">
                <div class="d-sm-flex align-items-start text-center text-sm-left">
                  <img src="<?= base_url('assets/images/illustration/horse.svg') ?>" class="mr-sm-4 mb-3 mb-sm-0" alt="" width="72">
                  <div class="flex-fill">
          ...
          <div class="card-deck-lg">
            ...
            <div class="card shadow" data-aos="fade-up" data-aos-delay="400">
              ...
              <div class="card-body p-4">
                <div class="d-sm-flex align-items-start text-center text-sm-left">
                  <img src="<?= base_url('assets/images/illustration/savings.svg') ?>" class="mr-sm-4 mb-3 mb-sm-0" alt="" width="72">
                  <div class="flex-fill">
            ...
            <div class="card shadow" data-aos="fade-up" data-aos-delay="500">
              ...
              <div class="card-body p-4">
                <div class="d-sm-flex align-items-start text-center text-sm-left">
                  <img src="<?= base_url('assets/images/illustration/document.svg') ?>" class="mr-sm-4 mb-3 mb-sm-0" alt="" width="72">
                  <div class="flex-fill">
      ...
      <section class="position-relative py-5 bg-light">
        ...
        <div class="sticker">
          <div class="sticker-item sticker-top-right sticker-soften translate-x-50">
            <img src="<?= base_url('assets/images/decoration/bubble1.svg') ?>" alt="" data-aos="fade-left">
          </div>
        </div><!-- /.sticker -->
        <!-- .container -->
        <div class="container position-relative">
            ...
            <div class="col-12 col-md-5 offset-md-1 py-md-4 pr-md-0">
              <div class="card font-size-lg shadow-lg" data-aos="fade-up">
                ...
                <div class="card-body p-4 p-lg-5">
                  ...
                  <ul class="list-icons">
                    <li class="mb-2 pl-1">
                      <span class="list-icon"><img class="mr-2" src="<?= base_url('assets/images/decoration/check.svg') ?>" alt="" width="16"></span> Build a Single End Product </li>
                    <li class="mb-2 pl-1">
                      <span class="list-icon"><img class="mr-2" src="<?= base_url('assets/images/decoration/check.svg') ?>" alt="" width="16"></span> Use for Personal or a Client </li>
                    <li class="mb-2 pl-1">
                      <span class="list-icon"><img class="mr-2" src="<?= base_url('assets/images/decoration/check.svg') ?>" alt="" width="16"></span> Make unlimited copies </li>
                    <li class="mb-2 pl-1">
                      <span class="list-icon"><img class="mr-2" src="<?= base_url('assets/images/decoration/check.svg') ?>" alt="" width="16"></span> Modify the Theme </li>
                    <li class="mb-2 pl-1">
                      <span class="list-icon"><img class="mr-2" src="<?= base_url('assets/images/decoration/check.svg') ?>" alt="" width="16"></span> Combine with another works </li>
                    <li class="mb-2 pl-1">
                      <span class="list-icon"><img class="mr-2" src="<?= base_url('assets/images/decoration/check.svg') ?>" alt="" width="16"></span> Free update forever </li>
                    <li class="mb-2 pl-1">
                      <span class="list-icon"><img class="mr-2" src="<?= base_url('assets/images/decoration/check.svg') ?>" alt="" width="16"></span> 24/7 support </li>
                  </ul>
                </div>
            ...
            <div class="col-12 col-md-5 py-md-4 pl-md-0">
              <div class="card font-size-lg card-inverse bg-primary shadow" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="card-body p-4 p-lg-5">
                  ...
                  <ul class="list-icons">
                    <li class="mb-2 pl-1">
                      <span class="list-icon"><img class="mr-2" src="<?= base_url('assets/images/decoration/check.svg') ?>" alt="" width="16"></span> Include all the Standar License </li>
                    <li class="mb-2 pl-1">
                      <span class="list-icon"><img class="mr-2" src="<?= base_url('assets/images/decoration/check.svg') ?>" alt="" width="16"></span> Use in an End Product that is "Sold" </li>
                    <li class="mb-2 pl-1">
                      <span class="list-icon"><img class="mr-2" src="<?= base_url('assets/images/decoration/check.svg') ?>" alt="" width="16"></span> Can have multiple paying users </li>
                  </ul>
                </div>
                <div class="card-footer">
      ...
      <section class="position-relative py-5 bg-light">
        ...
        <div class="sticker">
          <div class="sticker-item sticker-bottom-left sticker-soften">
            <img src="<?= base_url('assets/images/decoration/bubble2.svg') ?>" alt="" data-aos="zoom-in" data-aos-delay="200">
          </div>
        </div><!-- /.sticker -->
        <!-- .container -->
            ...
            <div class="col-12 col-md-8 offset-md-2 py-3">
              ...
              <div class="row justify-content-center text-center">
                <div class="col-4 col-md-3 col-lg-2 mb-5" data-aos="fade-up" data-aos-delay="0">
                  <img src="<?= base_url('assets/images/logo/airbnb.svg') ?>" alt="" class="img-fluid" style="max-height: 32px">
                </div>
                <div class="col-4 col-md-3 col-lg-2 mb-5" data-aos="fade-up" data-aos-delay="100">
                  <img src="<?= base_url('assets/images/logo/amazon.svg') ?>" alt="" class="img-fluid" style="max-height: 32px">
                </div>
                <div class="col-4 col-md-3 col-lg-2 mb-5" data-aos="fade-up" data-aos-delay="200">
                  <img src="<?= base_url('assets/images/logo/apple.svg') ?>" alt="" class="img-fluid" style="max-height: 32px">
                </div>
                <div class="col-4 col-md-3 col-lg-2 mb-5" data-aos="fade-up" data-aos-delay="300">
                  <img src="<?= base_url('assets/images/logo/dropbox.svg') ?>" alt="" class="img-fluid" style="max-height: 32px">
                </div>
                <div class="col-4 col-md-3 col-lg-2 mb-5" data-aos="fade-up" data-aos-delay="400">
                  <img src="<?= base_url('assets/images/logo/google.svg') ?>" alt="" class="img-fluid" style="max-height: 32px">
                </div>
                <div class="col-4 col-md-3 col-lg-2 mb-5" data-aos="fade-up" data-aos-delay="500">
                  <img src="<?= base_url('assets/images/logo/linkedin.svg') ?>" alt="" class="img-fluid" style="max-height: 32px">
                </div>
                <div class="col-4 col-md-3 col-lg-2 mb-5" data-aos="fade-up" data-aos-delay="600">
                  <img src="<?= base_url('assets/images/logo/paypal.svg') ?>" alt="" class="img-fluid" style="max-height: 32px">
                </div>
                <div class="col-4 col-md-3 col-lg-2 mb-5" data-aos="fade-up" data-aos-delay="700">
                  <img src="<?= base_url('assets/images/logo/shopify.svg') ?>" alt="" class="img-fluid" style="max-height: 32px">
                </div>
                <div class="col-4 col-md-3 col-lg-2 mb-5" data-aos="fade-up" data-aos-delay="900">
                  <img src="<?= base_url('assets/images/logo/sketch.svg') ?>" alt="" class="img-fluid" style="max-height: 32px">
                </div>
                <div class="col-4 col-md-3 col-lg-2 mb-5" data-aos="fade-up" data-aos-delay="1000">
                  <img src="<?= base_url('assets/images/logo/slack.svg') ?>" alt="" class="img-fluid" style="max-height: 32px">
                </div>
              </div><!-- /.row -->
            </div><!-- /.col -->
          </div><!-- /.row -->
          ...
          <div class="row">
            ...
            <div class="col-12 col-md-6 col-lg-4 offset-lg-1 mr-md-0">
              ...
              <div class="card shadow-none rounded-lg mb-0 mr-md-n5 mt-md-n5 scale-125" data-aos="fade-in">
                <img class="img-fluid rounded-lg" src="<?= base_url('assets/images/dummy/happy-client.jpg') ?>" alt="">
              </div><!-- /.card -->
            </div><!-- /.col -->
            <!-- .col -->
            <div class="col-12 col-md-6 col-lg-5 ml-md-0">
              ...
              <div class="card shadow-lg rounded-lg p-4 ml-md-n5 mt-md-5" data-aos="fade-up">
                <blockquote class="blockquote text-center border-0 p-3 p-md-4">
                  <figure>
                    <img class="mr-2" src="<?= base_url('assets/images/decoration/quote.svg') ?>" alt="" height="32">
                  </figure>
          ...
          <div class="card bg-success text-white position-relative overflow-hidden shadow rounded-lg p-4 mb-0" data-aos="fade-up">
            ...
            <div class="sticker">
              <div class="sticker-item sticker-middle-left">
                <img class="flip-y" src="<?= base_url('assets/images/decoration/bubble4.svg') ?>" alt="">
              </div>
            </div><!-- /.sticker -->
            <!-- .card-body -->
            ...
            <div class="col-12 col-md-4 col-lg-3">
              ...
              <ul class="list-inline mb-5 mb-md-0">
                <li class="list-inline-item mr-3" data-aos="fade-in" data-aos-delay="0">
                  <a href="#" class="text-muted text-decoration-none" title="twitter"><img class="grayscale" src="<?= base_url('assets/images/avatars/twitter.svg') ?>" alt="" width="24"></a>
                </li>
                <li class="list-inline-item mr-3" data-aos="fade-in" data-aos-delay="100">
                  <a href="#" class="text-muted text-decoration-none" title="instagram"><img class="grayscale" src="<?= base_url('assets/images/avatars/instagram.svg') ?>" alt="" width="24"></a>
                </li>
                <li class="list-inline-item mr-3" data-aos="fade-in" data-aos-delay="200">
                  <a href="#" class="text-muted text-decoration-none" title="dribbble"><img class="grayscale" src="<?= base_url('assets/images/avatars/dribbble.svg') ?>" alt="" width="24"></a>
                </li>
                <li class="list-inline-item mr-3" data-aos="fade-in" data-aos-delay="300">
                  <a href="#" class="text-muted text-decoration-none" title="medium"><img class="grayscale" src="<?= base_url('assets/images/avatars/medium.svg') ?>" alt="" width="24"></a>
                </li>
              </ul>
            </div><!-- /.col -->
            <!-- .col -->
    ...
    <!-- BEGIN PLUGINS JS -->
    <script src="<?= base_url('assets/vendor/aos/aos.js') ?>"></script> <!-- END PLUGINS JS -->
    <!-- BEGIN THEME JS -->
