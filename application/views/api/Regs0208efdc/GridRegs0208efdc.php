              ...
              <nav aria-label='breadcrumb'>
                <ol class='breadcrumb'>
                  <li class='breadcrumb-item active'>
                    <a href='#'><i class='breadcrumb-icon fa fa-angle-left mr-2'></i>Grupos por Marca Comercial – Refri</a>
                  </li>
                </ol>
              </nav><!-- /.breadcrumb -->
              <!-- floating action -->
              <button type='button' class='btn btn-success btn-floated' onclick="window.location.href='<?= base_url('Regs0208efdc/create') ?>'"><span class='fa fa-plus'></span></button> <!-- /floating action -->
            ...
            <div class='page-section'>
              ...
              <div class='card card-fluid'>
                ...
                <div class='card-header d-md-flex align-items-md-start'>
                  <h1 class='page-title mr-sm-auto'> Grupos por Marca Comercial – Refri </h1><!-- .btn-toolbar -->
                ...
                <div class='card-body'>
                      ...
                      <div class='input-group-prepend'>
                        <select id='filterBy' class='custom-select' style='width: 150px'>
                          <option value='' selected> Filtrar por </option>
													...
													<option value='2'> Código Tabela de Incidência </option>
													<option value='3'> Código Grupo </option>
													<option value='4'> Marca Comercial </option>
                  ...
                  <!-- .table -->
                  <table id='myTableRegs0208efdc' class='table'>
                    <!-- thead -->
                    <thead>
                      <tr>
                        <th>
                          <div class='thead-dd dropdown'>
                            ...
                            <div class='dropdown-menu'>
                              ...
                              <a class='dropdown-item' href='#'>Separate actions</a>
												...
												<th> Registro </th>
												<th> Código Tabela de Incidência </th>
												<th> Código Grupo </th>
    ...
    <title>Grupos por Marca Comercial – Refri</title>
<script>
var url_get = '<?= base_url('regs0208efdc/get'); ?>';
