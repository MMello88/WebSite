              ...
              <nav aria-label='breadcrumb'>
                <ol class='breadcrumb'>
                  <li class='breadcrumb-item active'>
                    <a href='#'><i class='breadcrumb-icon fa fa-angle-left mr-2'></i>Código Fiscal de Operação e Prestação</a>
                  </li>
                </ol>
              </nav><!-- /.breadcrumb -->
              <!-- floating action -->
              <button type='button' class='btn btn-success btn-floated' onclick="window.location.href='<?= base_url('Ref422/create') ?>'"><span class='fa fa-plus'></span></button> <!-- /floating action -->
            ...
            <div class='page-section'>
              ...
              <div class='card card-fluid'>
                ...
                <div class='card-header d-md-flex align-items-md-start'>
                  <h1 class='page-title mr-sm-auto'> Código Fiscal de Operação e Prestação </h1><!-- .btn-toolbar -->
                ...
                <div class='card-body'>
                  ...
                  <!-- .table -->
                  <table id='myTableRef422' class='table'>
                    <!-- thead -->
                    <thead>
                      <tr>
                        <th>
    ...
    <title>Código Fiscal de Operação e Prestação</title>
<script>
