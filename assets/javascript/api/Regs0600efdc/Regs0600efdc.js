...
var DTRegs0600efdc =
function () {
  function DTRegs0600efdc() {
    _classCallCheck(this, DTRegs0600efdc);
    this.init();
  }

  _createClass(DTRegs0600efdc, [{
    key: "init",
    value: function init() {
    ...
    value: function table() {
      return $('#myTableRegs0600efdc').DataTable({
        dom: "<'text-muted'Bi>\n        <'table-responsive'tr>\n        <'mt-4'p>",
        buttons: ['copyHtml5', {
          extend: 'print', 
          autoPrint: false
    ...
    value: function clearSelected() {
      ...
      $('#myTableRegs0600efdc').on('page.dt', function () {
        self.clearSelectedRows();
      });
