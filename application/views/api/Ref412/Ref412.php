                      ...
                      <div class='input-group-prepend'>
                        <select id='filterBy' class='custom-select'>
                          <option value='' selected> Filtrar por </option>
													<option value='0'> 412_Id </option>
													<option value='1'> 412_Codigo </option>
													<option value='2'> 412_Descricao </option>
													<option value='3'> 412_DtIni </option>
													<option value='4'> 412_DtFin </option>
