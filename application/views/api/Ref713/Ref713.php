              ...
              <nav aria-label='breadcrumb'>
                <ol class='breadcrumb'>
                  <li class='breadcrumb-item active'>
                    <a href='#'><i class='breadcrumb-icon fa fa-angle-left mr-2'></i>Detalhamento Analítico das Receitas</a>
                  </li>
                </ol>
              </nav><!-- /.breadcrumb -->
              <!-- floating action -->
            ...
            <div class='page-section'>
              ...
              <div class='card card-fluid'>
                ...
                <div class='card-header d-md-flex align-items-md-start'>
                  <h1 class='page-title mr-sm-auto'> Detalhamento Analítico das Receitas </h1><!-- .btn-toolbar -->
                      ...
                      <div class='input-group-prepend'>
                        <select id='filterBy' class='custom-select'>
                          <option value='' selected> Filtrar por </option>
													<option value='0'> 713_Id </option>
													<option value='1'> 713_Codigo </option>
													<option value='2'> 713_Descricao </option>
													<option value='3'> 713_DtIni </option>
													<option value='4'> 713_DtFin </option>
													<option value='5'> 713_IndTipoAtividade </option>
													<option value='6'> 713_IndAjuste </option>
													<option value='7'> 713_Grupo </option>
													<option value='8'> 713_SubGrupo </option>
													<option value='9'> 713_IndOutros </option>
    ...
    <title>Detalhamento Analítico das Receitas</title>
<script>
