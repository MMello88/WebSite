...
var DTUsersgrupo =
function () {
  function DTUsersgrupo() {
    _classCallCheck(this, DTUsersgrupo);
    this.init();
  }

  _createClass(DTUsersgrupo, [{
    key: "init",
    value: function init() {
    ...
    value: function table() {
      return $('#myTableUsersgrupo').DataTable({
        dom: "<'text-muted'Bi>\n        <'table-responsive'tr>\n        <'mt-4'p>",
        buttons: ['copyHtml5', {
          extend: 'print', 
          autoPrint: false
        ...
        columnDefs: [{
          ...
          render: function render(data, type, row, meta) {
            ...
            <div class='custom-control custom-control-nolabel custom-checkbox'>
              <input type='checkbox' class='custom-control-input' name='selectedRow[]' id='p${row['ug_GrupoUserId']}' value='${row['ug_GrupoUserId']}'>
              <label class='custom-control-label' for='p${row['ug_GrupoUserId']}'></label>
            </div>`;
          }
        },{
          targets: 1,
          render: function render(data, type, row, meta) {
            return `
            <a class='btn btn-sm btn-icon btn-secondary' href='${url_view_usersgrupo}/${data}'>
              <i class='fa fa-eye'></i>
            </a>
    ...
    value: function clearSelected() {
      ...
      $('#myTableUsersgrupo').on('page.dt', function () {
        self.clearSelectedRows();
      });
