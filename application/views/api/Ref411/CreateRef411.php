                    ...
                    <?= form_open(base_url('Ref411/add')); ?>
                      ...
                      <fieldset>
                        <legend>Adicionar um novo registro</legend> <!-- .form-group -->
							...
							<input type='text' name='411_Codigo' id='411_Codigo' class='form-control' placeholder='Código' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='411_Descricao' id='411_Descricao' class='form-control' placeholder='Descrição' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='411_Modelo' id='411_Modelo' class='form-control' placeholder='Modelo' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='date' name='411_DtIni' id='411_DtIni' class='form-control' placeholder='Data Inicial' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='date' name='411_DtFin' id='411_DtFin' class='form-control' placeholder='Data Final' value='' >
							<?php if(isset($response)): ?>
