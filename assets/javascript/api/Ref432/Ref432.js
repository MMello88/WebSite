...
function () {
  function DTRef432() {
    _classCallCheck(this, DTRef432);
    this.init();
  }

  _createClass(DTRef432, [{
    key: "init",
    value: function init() {
    ...
    value: function table() {
      return $('#myTableRef432').DataTable({
        dom: "<'text-muted'Bi>\n        <'table-responsive'tr>\n        <'mt-4'p>",
        buttons: ['copyHtml5', {
          extend: 'print', 
          autoPrint: false
        ...
        columnDefs: [{
          ...
          render: function render(data, type, row, meta) {
            ...
            <div class='custom-control custom-control-nolabel custom-checkbox'>
              <input type='checkbox' class='custom-control-input' name='selectedRow[]' id='p${row['432_Id']}' value='${row['432_Id']}'>
              <label class='custom-control-label' for='p${row['432_Id']}'></label>
            </div>`;
          }
        },{
          targets: 1,
    ...
    value: function clearSelected() {
      ...
      $('#myTableRef432').on('page.dt', function () {
        self.clearSelectedRows();
      });
