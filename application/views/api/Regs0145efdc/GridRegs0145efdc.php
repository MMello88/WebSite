              ...
              <nav aria-label='breadcrumb'>
                <ol class='breadcrumb'>
                  <li class='breadcrumb-item active'>
                    <a href='#'><i class='breadcrumb-icon fa fa-angle-left mr-2'></i>Regime de Apuração da Contribuição Previdenciária Sobre a Receita Bruta</a>
                  </li>
                </ol>
              </nav><!-- /.breadcrumb -->
              <!-- floating action -->
              <button type='button' class='btn btn-success btn-floated' onclick="window.location.href='<?= base_url('Regs0145efdc/create') ?>'"><span class='fa fa-plus'></span></button> <!-- /floating action -->
            ...
            <div class='page-section'>
              ...
              <div class='card card-fluid'>
                ...
                <div class='card-header d-md-flex align-items-md-start'>
                  <h1 class='page-title mr-sm-auto'> Regime de Apuração da Contribuição Previdenciária Sobre a Receita Bruta </h1><!-- .btn-toolbar -->
                      ...
                      <div class='input-group-prepend'>
                        <select id='filterBy' class='custom-select' style='width: 150px'>
                          <option value='' selected> Filtrar por </option>
													...
													<option value='3'> Valor da Receita Bruta Total </option>
													<option value='4'> Valor da Receita Bruta da Atividade </option>
													<option value='5'> Valor da Receita Bruta das demais Atividade </option>
													<option value='6'> Informação complementar </option>
                          ...
                          <div class='thead-dd dropdown'>
                            ...
                            <div class='dropdown-menu'>
                              ...
                              <a class='dropdown-item' href='#'>Separate actions</a>
												...
												<th> Valor da Receita Bruta Total </th>
												<th> Valor da Receita Bruta da Atividade </th>
												<th> Valor da Receita Bruta das demais Atividade </th>
    ...
    <title>Regime de Apuração da Contribuição Previdenciária Sobre a Receita Bruta</title>
<script>
