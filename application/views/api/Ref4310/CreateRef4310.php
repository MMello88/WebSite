                    ...
                    <?= form_open(base_url('Ref4310/add')); ?>
                      ...
                      <fieldset>
                        <legend>Adicionar um novo registro</legend> <!-- .form-group -->
							...
							<input type='number' step='0.01' name='4310_AliqPis' id='4310_AliqPis' class='form-control' placeholder='Alíquota do PIS %' value='<?= isset($response['data']['4310_AliqPis']) ? $response['data']['4310_AliqPis'] : '' ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='number' step='0.01' name='4310_AliqCofins' id='4310_AliqCofins' class='form-control' placeholder='Alíquota da COFINS %' value='<?= isset($response['data']['4310_AliqCofins']) ? $response['data']['4310_AliqCofins'] : '' ?>' required>
							<?php if(isset($response)): ?>
