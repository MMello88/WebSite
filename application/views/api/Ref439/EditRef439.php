                    ...
                    <?= form_open(base_url('Ref439/update/'.$response['data'][0]['439_Id'])); ?>
                      ...
                      <fieldset>
                        <legend>Alteração do registro</legend> <!-- .form-group -->
							...
							<input type='number' step='0.01' name='439_AliqPis' id='439_AliqPis' class='form-control' placeholder='Alíquota do PIS %' value='<?= $response['data'][0]['439_AliqPis'] ?>' >
							<?php if(isset($response)): ?>
							...
							<input type='number' step='0.01' name='439_AliqCofins' id='439_AliqCofins' class='form-control' placeholder='Alíquota da COFINS %' value='<?= $response['data'][0]['439_AliqCofins'] ?>' >
							<?php if(isset($response)): ?>
