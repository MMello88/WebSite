                    ...
                    <?= form_open(base_url('Regsa100efdc/add')); ?>
                      ...
                      <fieldset>
                        <legend>Adicionar um novo registro</legend> <!-- .form-group -->
							...
							<input type='text' name='a100_Reg' id='a100_Reg' class='form-control' placeholder='Registro' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='a100_CNPJ' id='a100_CNPJ' class='form-control' placeholder='CNPJ' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='number' name='a100_IndicadorTipoOperacao' id='a100_IndicadorTipoOperacao' class='form-control' placeholder='Indicador Tipo Operação' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='number' name='a100_IndicadorEmitenteDocumento' id='a100_IndicadorEmitenteDocumento' class='form-control' placeholder='Indicador Emitente' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='number' name='Reg0150EFDCId' id='Reg0150EFDCId' class='form-control' placeholder='Participante' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='number' name='a100_SituacaoDocumentoFiscal' id='a100_SituacaoDocumentoFiscal' class='form-control' placeholder='Código Situação' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='a100_Ser' id='a100_Ser' class='form-control' placeholder='Série' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='a100_Sub' id='a100_Sub' class='form-control' placeholder='Subserie' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='a100_NumDoc' id='a100_NumDoc' class='form-control' placeholder='Número Documento' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='a100_ChaveEletronica' id='a100_ChaveEletronica' class='form-control' placeholder='Chave Eletrônica' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='date' name='a100_DtEmissaoDoc' id='a100_DtEmissaoDoc' class='form-control' placeholder='Data Emissão Documento' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='date' name='a100_DtConclusaoServico' id='a100_DtConclusaoServico' class='form-control' placeholder='Data Conclusão do Serviço' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='' name='a100_VlDocumento' id='a100_VlDocumento' class='form-control' placeholder='Valor Total' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='' name='a100_VlDesconto' id='a100_VlDesconto' class='form-control' placeholder='Valor Total do Desconto' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='' name='a100_VlBcPis' id='a100_VlBcPis' class='form-control' placeholder='Valor Base Cálculo PIS/PASEP' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='' name='a100_VlPis' id='a100_VlPis' class='form-control' placeholder='Valor Total do PIS' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='' name='a100_VlBcCofins' id='a100_VlBcCofins' class='form-control' placeholder='Valor Base Cálculo COFINS' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='' name='a100_VlCofins' id='a100_VlCofins' class='form-control' placeholder='Valor Total COFINS' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='' name='a100_VlPisRetido' id='a100_VlPisRetido' class='form-control' placeholder='Valor Total do PIS Retido na Fonte' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='' name='a100_VlConfinsRetido' id='a100_VlConfinsRetido' class='form-control' placeholder='Valor Total da COFINS Retido na Fonte' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='' name='a100_VlIss' id='a100_VlIss' class='form-control' placeholder='Valor do ISS' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='date' name='a100_DtIni' id='a100_DtIni' class='form-control' placeholder='Data Inicial' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='date' name='a100_DtFin' id='a100_DtFin' class='form-control' placeholder='Data Final' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='number' name='a100_PessoaJuridicaId' id='a100_PessoaJuridicaId' class='form-control' placeholder='Pessoa Juridica' value='' >
							<?php if(isset($response)): ?>
							...
							<div class='form-group'>
								<label for='a100_UsersId'>Usuário</label>
							<input type='number' name='a100_UsersId' id='a100_UsersId' class='form-control' placeholder='Usuário' value='' >
							<?php if(isset($response)): ?>
								<div class='invalid-feedback' style='display:block'><?= isset($response['error']['a100_UsersId']) ? $response['error']['a100_UsersId'] : ''; ?></div>
							<?php endif; ?>
						</div>
