              ...
              <nav aria-label='breadcrumb'>
                <ol class='breadcrumb'>
                  <li class='breadcrumb-item active'>
                    <a href='#'><i class='breadcrumb-icon fa fa-angle-left mr-2'></i>Pessoa Fisica</a>
                  </li>
                </ol>
              </nav><!-- /.breadcrumb -->
              <!-- floating action -->
              <button type='button' class='btn btn-success btn-floated' onclick="window.location.href='<?= base_url('Pessoasfisica/create') ?>'"><span class='fa fa-plus'></span></button> <!-- /floating action -->
            ...
            <div class='page-section'>
              ...
              <div class='card card-fluid'>
                ...
                <div class='card-header d-md-flex align-items-md-start'>
                  <h1 class='page-title mr-sm-auto'> Pessoa Fisica </h1><!-- .btn-toolbar -->
                ...
                <div class='card-body'>
                      ...
                      <div class='input-group-prepend'>
                        <select id='filterBy' class='custom-select' style='width: 150px'>
                          <option value='' selected> Filtrar por </option>
													...
													<option value='4'> Foto Perfil </option>
                  ...
                  <!-- .table -->
                  <table id='myTablePessoasfisica' class='table'>
                    <!-- thead -->
                    <thead>
                      <tr>
                        <th>
...
<div class='modal fade' id='modalDeleteRegistro' tabindex='-1' role='dialog' aria-labelledby='ModalDeleteLabel' aria-hidden='true'>
  ...
  <div class='modal-dialog modal-dialog-centered' role='document'>
    ...
    <div class='modal-content'>
      ...
      <?= form_open('pessoasfisica/delete') ?>
        <!-- .modal-body -->
