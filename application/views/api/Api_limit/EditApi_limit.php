            ...
            <div class='page-section'>
              ...
              <div class='section-block'>            
                ...
                <div id='base-style' class='card'>
                  ...
                  <div class='card-body'>
                    <!-- .form -->
                    <?= form_open(base_url('Api_limit/update/'.$response['data'][0]['id'])); ?>
                      <!-- .fieldset -->
                      <fieldset>
                        <legend>Alteração do registro</legend> <!-- .form-group -->
							<div class='form-group'>
								<label for='uri'></label>
							<input type='text' name='uri' id='uri' class='form-control' placeholder='' value='<?= $response['data'][0]['uri'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='class' id='class' class='form-control' placeholder='' value='<?= $response['data'][0]['class'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='method' id='method' class='form-control' placeholder='' value='<?= $response['data'][0]['method'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='ip_address' id='ip_address' class='form-control' placeholder='' value='<?= $response['data'][0]['ip_address'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='' name='time' id='time' class='form-control' placeholder='' value='<?= $response['data'][0]['time'] ?>' required>
							<?php if(isset($response)): ?>
