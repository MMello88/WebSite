              ...
              <nav aria-label='breadcrumb'>
                <ol class='breadcrumb'>
                  <li class='breadcrumb-item active'>
                    <a href='#'><i class='breadcrumb-icon fa fa-angle-left mr-2'></i>Identificação das Unidades de Medida</a>
                  </li>
                </ol>
              </nav><!-- /.breadcrumb -->
              <!-- floating action -->
            ...
            <div class='page-section'>
              ...
              <div class='card card-fluid'>
                ...
                <div class='card-header d-md-flex align-items-md-start'>
                  <h1 class='page-title mr-sm-auto'> Identificação das Unidades de Medida </h1><!-- .btn-toolbar -->
                      ...
                      <div class='input-group-prepend'>
                        <select id='filterBy' class='custom-select'>
                          <option value='' selected> Filtrar por </option>
													<option value='0'> 0190_Id </option>
													<option value='1'> 0190_Reg </option>
													<option value='2'> 0190_Unidade </option>
													<option value='3'> 0190_Descrição </option>
													<option value='4'> 0190_DtIni </option>
													<option value='5'> 0190_DtFin </option>
    ...
    <title>Identificação das Unidades de Medida</title>
<script>
