                    ...
                    <!-- .form -->
                      ...
                      <fieldset>
                        <legend>Alteração do registro</legend> <!-- .form-group -->
							...
							<input type='text' name='ProductVersion' id='ProductVersion' class='form-control' placeholder='' value='<?= isset($response['data'][0]['ProductVersion']) ? $response['data'][0]['ProductVersion'] : '' ?>' required disabled>
							<?php if(isset($response)): ?>
