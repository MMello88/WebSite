      ...
      public function add(){
        if($_POST){
          ...
          if($response['status'] == 'FALSE'){
            ...
            $salvarEVoltar ? redirect('regsa111efdc') : redirect('regsa111efdc/edit/'.$response['data'][0]['a111_Id']);
          }
        }
      }
      ...
      public function update($Id){
        if($_POST){
          ...
          if($response['status'] == 'FALSE'){
            ...
            $salvarEVoltar ? redirect('regsa111efdc') : redirect('regsa111efdc/edit/'.$Id);
          }
        }
      }
