...
var DTPerfismenu =
function () {
  function DTPerfismenu() {
    _classCallCheck(this, DTPerfismenu);
    this.init();
  }

  _createClass(DTPerfismenu, [{
    key: "init",
    value: function init() {
    ...
    value: function table() {
      return $('#myTablePerfismenu').DataTable({
        dom: "<'text-muted'Bi>\n        <'table-responsive'tr>\n        <'mt-4'p>",
        buttons: ['copyHtml5', {
          extend: 'print', 
          autoPrint: false
        ...
        columnDefs: [{
          ...
          render: function render(data, type, row, meta) {
            ...
            <div class='custom-control custom-control-nolabel custom-checkbox'>
              <input type='checkbox' class='custom-control-input' name='selectedRow[]' id='p${row['pm_Id']}' value='${row['pm_Id']}'>
              <label class='custom-control-label' for='p${row['pm_Id']}'></label>
            </div>`;
          }
        },{
          targets: 1,
    ...
    value: function clearSelected() {
      ...
      $('#myTablePerfismenu').on('page.dt', function () {
        self.clearSelectedRows();
      });
