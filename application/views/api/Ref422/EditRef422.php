            ...
            <div class='page-section'>
              ...
              <div class='section-block'>            
                ...
                <div id='base-style' class='card'>
                  ...
                  <div class='card-body'>
                    <!-- .form -->
                    <?= form_open(base_url('Ref422/update/'.$response['data'][0]['422_Id'])); ?>
                      <!-- .fieldset -->
                      <fieldset>
                        <legend>Alteração do registro</legend> <!-- .form-group -->
							<div class='form-group'>
								<label for='422_Codigo'>Código</label>
							<input type='text' name='422_Codigo' id='422_Codigo' class='form-control' placeholder='Código' value='<?= $response['data'][0]['422_Codigo'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='422_Descricao' id='422_Descricao' class='form-control' placeholder='Descrição' value='<?= $response['data'][0]['422_Descricao'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='date' name='422_DtIni' id='422_DtIni' class='form-control' placeholder='Data Inicial' value='<?= $response['data'][0]['422_DtIni'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='date' name='422_DtFin' id='422_DtFin' class='form-control' placeholder='Data Final' value='<?= $response['data'][0]['422_DtFin'] ?>' >
							<?php if(isset($response)): ?>
