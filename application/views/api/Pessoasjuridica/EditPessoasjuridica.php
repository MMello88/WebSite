            ...
            <div class='page-section'>
              ...
              <div class='section-block'>            
                ...
                <div id='base-style' class='card'>
                  ...
                  <div class='card-body'>
                    <!-- .form -->
                    <?= form_open(base_url('Pessoasjuridica/update/'.$parentView.'/'.$IdParent.'/'.$response['data'][0]['pj_Id'])); ?>
                      <!-- .fieldset -->
                      <fieldset>
                        <legend>Alteração do registro</legend> <!-- .form-group -->
							...
							<input type='number' step='1' name='pj_Matriz' id='pj_Matriz' class='form-control' placeholder='Matriz' value='<?= $response['data'][0]['pj_Matriz'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='number' step='1' name='pj_NaturezaJuridica' id='pj_NaturezaJuridica' class='form-control' placeholder='Natureza Juridica' value='<?= $response['data'][0]['pj_NaturezaJuridica'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='number' step='1' name='pj_DmContribuicao' id='pj_DmContribuicao' class='form-control' placeholder='Contribuinte' value='<?= $response['data'][0]['pj_DmContribuicao'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<select name='pj_MunicipioId' id='pj_MunicipioId' class='custom-select' placeholder='Municipio' required>
								<?= getOptionToSelect('municipios','mun_Id', '', $response['data'][0]['pj_MunicipioId'], $login->data->token) ?>
							</select>
							<?php if(isset($response)): ?>
							...
							<select name='pj_PessoaFisicaId' id='pj_PessoaFisicaId' class='custom-select' placeholder='Pessoa Fisica' required>
								<?= getOptionToSelect('pessoasfisica','pf_Id', '', $response['data'][0]['pj_PessoaFisicaId'], $login->data->token) ?>
							</select>
							<?php if(isset($response)): ?>
