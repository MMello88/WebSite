                    ...
                    <?= form_open(base_url('Regs0100efdc/add')); ?>
                      ...
                      <fieldset>
                        <legend>Adicionar um novo registro</legend> <!-- .form-group -->
							...
							<input type='text' name='0100_Reg' id='0100_Reg' class='form-control' placeholder='Registro' value='0100' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='0100_Nome' id='0100_Nome' class='form-control' placeholder='Nome' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='number' name='0100_CPF' id='0100_CPF' class='form-control' placeholder='CPF' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='0100_CRC' id='0100_CRC' class='form-control' placeholder='CRC' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='number' name='0100_CNPJ' id='0100_CNPJ' class='form-control' placeholder='CNPJ' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='number' name='0100_CEP' id='0100_CEP' class='form-control' placeholder='CEP' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='0100_End' id='0100_End' class='form-control' placeholder='Endereço' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='0100_Num' id='0100_Num' class='form-control' placeholder='Número' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='0100_Compl' id='0100_Compl' class='form-control' placeholder='Complemento' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='0100_Bairro' id='0100_Bairro' class='form-control' placeholder='Bairro' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='0100_Fone' id='0100_Fone' class='form-control' placeholder='Fone' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='0100_Fax' id='0100_Fax' class='form-control' placeholder='Fax' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='0100_Email' id='0100_Email' class='form-control' placeholder='E-mail' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='number' name='0100_MunicipioId' id='0100_MunicipioId' class='form-control' placeholder='Municipio' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='date' name='0100_DtIni' id='0100_DtIni' class='form-control' placeholder='Data Inicial' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='date' name='0100_DtFin' id='0100_DtFin' class='form-control' placeholder='Data Final' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='number' name='0100_PessoaJuridicaId' id='0100_PessoaJuridicaId' class='form-control' placeholder='Pessoa Juridica' value='' >
							<?php if(isset($response)): ?>
							...
							<div class='form-group'>
								<label for='0100_UsersId'>Usuário</label>
							<input type='number' name='0100_UsersId' id='0100_UsersId' class='form-control' placeholder='Usuário' value='' >
							<?php if(isset($response)): ?>
								<div class='invalid-feedback' style='display:block'><?= isset($response['error']['0100_UsersId']) ? $response['error']['0100_UsersId'] : ''; ?></div>
							<?php endif; ?>
						</div>
...
<script>
  var url_get = '<?= base_url('regs0100efdc/create'); ?>';
