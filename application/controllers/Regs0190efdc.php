      ...
      public function add(){
        if($_POST){
          ...
          if($response['status'] == 'FALSE'){
            ...
            $salvarEVoltar ? redirect('regs0190efdc') : redirect('regs0190efdc/edit/'.$response['data'][0]['0190_Id']);
          }
        }
      }
      ...
      public function update($Id){
        if($_POST){
          ...
          if($response['status'] == 'FALSE'){
            ...
            $salvarEVoltar ? redirect('regs0190efdc') : redirect('regs0190efdc/edit/'.$Id);
          }
        }
      }
