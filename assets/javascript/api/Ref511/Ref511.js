...
function () {
  function DTRef511() {
    _classCallCheck(this, DTRef511);
    this.init();
  }

  _createClass(DTRef511, [{
    key: "init",
    value: function init() {
    ...
    value: function table() {
      return $('#myTableRef511').DataTable({
        dom: "<'text-muted'Bi>\n        <'table-responsive'tr>\n        <'mt-4'p>",
        buttons: ['copyHtml5', {
          extend: 'print', 
          autoPrint: false
        ...
        columns: [
				...
				{
					data: '511_IndNcmAtividade',
					className: 'align-middle',
				},
				{
					data: '511_AliqAtividade',
					className: 'align-middle',
				},
        ...
        columnDefs: [{
          ...
          render: function render(data, type, row, meta) {
            ...
            <div class='custom-control custom-control-nolabel custom-checkbox'>
              <input type='checkbox' class='custom-control-input' name='selectedRow[]' id='p${row['511_Id']}' value='${row['511_Id']}'>
              <label class='custom-control-label' for='p${row['511_Id']}'></label>
            </div>`;
          }
        },{
          targets: 1,
    ...
    value: function clearSelected() {
      ...
      $('#myTableRef511').on('page.dt', function () {
        self.clearSelectedRows();
      });
