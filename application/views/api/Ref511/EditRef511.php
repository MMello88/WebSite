                    ...
                    <?= form_open(base_url('Ref511/update/'.$response['data'][0]['511_Id'])); ?>
                      ...
                      <fieldset>
                        <legend>Alteração do registro</legend> <!-- .form-group -->
							...
							<input type='number' name='511_AliqAtividade' id='511_AliqAtividade' class='form-control' placeholder='Aliquota Atividade' value='<?= $response['data'][0]['511_AliqAtividade'] ?>' >
							<?php if(isset($response)): ?>
