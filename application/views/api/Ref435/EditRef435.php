            ...
            <div class='page-section'>
              ...
              <div class='section-block'>            
                ...
                <div id='base-style' class='card'>
                  ...
                  <div class='card-body'>
                    <!-- .form -->
                    <?= form_open(base_url('Ref435/update/'.$response['data'][0]['435_Id'])); ?>
                      <!-- .fieldset -->
                      <fieldset>
                        <legend>Alteração do registro</legend> <!-- .form-group -->
							<div class='form-group'>
								<label for='435_Codigo'>Código</label>
							<input type='text' name='435_Codigo' id='435_Codigo' class='form-control' placeholder='Código' value='<?= $response['data'][0]['435_Codigo'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='435_Descricao' id='435_Descricao' class='form-control' placeholder='Descrição' value='<?= $response['data'][0]['435_Descricao'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='date' name='435_DtIni' id='435_DtIni' class='form-control' placeholder='Data Inicial' value='<?= $response['data'][0]['435_DtIni'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='date' name='435_DtFin' id='435_DtFin' class='form-control' placeholder='Data Final' value='<?= $response['data'][0]['435_DtFin'] ?>' >
							<?php if(isset($response)): ?>
