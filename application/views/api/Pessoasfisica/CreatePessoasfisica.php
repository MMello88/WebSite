                    ...
                    <?= form_open(base_url('Pessoasfisica/add')); ?>
                      ...
                      <fieldset>
                        <legend>Adicionar um novo registro</legend> <!-- .form-group -->
							...
							<input type='datetime-local'  name='pf_Criacao' id='pf_Criacao' class='form-control' placeholder='' value='<?= isset($response['data']['pf_Criacao']) ? (substr($response['data']['pf_Criacao'],10,1) !== 'T' ? date_format(date_create_from_format('Y-m-d H:i:s', $response['data']['pf_Criacao']),'Y-m-d\TH:i') : $response['data']['pf_Criacao']) : 'CURRENT_TIMESTAMP(6)' ?>' required>
							<?php if(isset($response)): ?>
