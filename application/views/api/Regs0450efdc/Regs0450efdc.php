                      ...
                      <div class='input-group-prepend'>
                        <select id='filterBy' class='custom-select'>
                          <option value='' selected> Filtrar por </option>
													<option value='0'> 0450_Id </option>
													<option value='1'> 0450_Reg </option>
													<option value='2'> 0450_CodInf </option>
													<option value='3'> 0450_Txt </option>
													<option value='4'> 0450_DtIni </option>
													<option value='5'> 0450_DtFin </option>
