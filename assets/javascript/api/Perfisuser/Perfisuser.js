...
var DTPerfisuser =
function () {
  function DTPerfisuser() {
    _classCallCheck(this, DTPerfisuser);
    this.init();
  }

  _createClass(DTPerfisuser, [{
    key: "init",
    value: function init() {
    ...
    value: function table() {
      return $('#myTablePerfisuser').DataTable({
        dom: "<'text-muted'Bi>\n        <'table-responsive'tr>\n        <'mt-4'p>",
        buttons: ['copyHtml5', {
          extend: 'print', 
          autoPrint: false
        ...
        columnDefs: [{
          ...
          render: function render(data, type, row, meta) {
            ...
            <div class='custom-control custom-control-nolabel custom-checkbox'>
              <input type='checkbox' class='custom-control-input' name='selectedRow[]' id='p${row['pu_Id']}' value='${row['pu_Id']}'>
              <label class='custom-control-label' for='p${row['pu_Id']}'></label>
            </div>`;
          }
        },{
          targets: 1,
    ...
    value: function clearSelected() {
      ...
      $('#myTablePerfisuser').on('page.dt', function () {
        self.clearSelectedRows();
      });
