              ...
              <nav aria-label='breadcrumb'>
                <ol class='breadcrumb'>
                  <li class='breadcrumb-item active'>
                    <a href='<?= base_url('Municipios/'.$parentView.'/'.$IdParent) ?>'><i class='breadcrumb-icon fa fa-angle-left mr-2'></i>Voltar</a>
                  </li>
                </ol>
              </nav><!-- /.breadcrumb -->
                    ...
                    <!-- .form -->
                      ...
                      <fieldset>
                        <legend>Alteração do registro</legend> <!-- .form-group -->
							...
							<input type='number' step='1' name='0150_CNPJ' id='0150_CNPJ' class='form-control' placeholder='CNPJ' value='<?= isset($response['data'][0]['0150_CNPJ']) ? $response['data'][0]['0150_CNPJ'] : '' ?>' required disabled>
							<?php if(isset($response)): ?>
							...
							<input type='number' step='1' name='0150_CPF' id='0150_CPF' class='form-control' placeholder='CPF' value='<?= isset($response['data'][0]['0150_CPF']) ? $response['data'][0]['0150_CPF'] : '' ?>' required disabled>
							<?php if(isset($response)): ?>
