...
var DTRegs0190efdc =
function () {
  function DTRegs0190efdc() {
    _classCallCheck(this, DTRegs0190efdc);
    this.init();
  }

  _createClass(DTRegs0190efdc, [{
    key: "init",
    value: function init() {
    ...
    value: function table() {
      return $('#myTableRegs0190efdc').DataTable({
        dom: "<'text-muted'Bi>\n        <'table-responsive'tr>\n        <'mt-4'p>",
        buttons: ['copyHtml5', {
          extend: 'print', 
          autoPrint: false
        ...
        columnDefs: [{
          ...
          render: function render(data, type, row, meta) {
            ...
            <div class='custom-control custom-control-nolabel custom-checkbox'>
              <input type='checkbox' class='custom-control-input' name='selectedRow[]' id='p${row['0190_Id']}' value='${row['0190_Id']}'>
              <label class='custom-control-label' for='p${row['0190_Id']}'></label>
            </div>`;
          }
        },{
          targets: 1,
    ...
    value: function clearSelected() {
      ...
      $('#myTableRegs0190efdc').on('page.dt', function () {
        self.clearSelectedRows();
      });
