                      ...
                      <div class='input-group-prepend'>
                        <select id='filterBy' class='custom-select'>
                          <option value='' selected> Filtrar por </option>
													<option value='0'> 0400_Id </option>
													<option value='1'> 0400_Reg </option>
													<option value='2'> 0400_CodNat </option>
													<option value='3'> 0400_DescricaoNat </option>
													<option value='4'> 0400_DtIni </option>
													<option value='5'> 0400_DtFin </option>
