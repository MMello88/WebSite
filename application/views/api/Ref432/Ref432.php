                      ...
                      <div class='input-group-prepend'>
                        <select id='filterBy' class='custom-select'>
                          <option value='' selected> Filtrar por </option>
													<option value='0'> 432_Id </option>
													<option value='1'> 432_Codigo </option>
													<option value='2'> 432_Descricao </option>
													<option value='3'> 432_DtIni </option>
													<option value='4'> 432_DtFin </option>
