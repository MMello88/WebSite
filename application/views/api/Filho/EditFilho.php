            ...
            <div class='page-section'>
              ...
              <div class='section-block'>            
                ...
                <div id='base-style' class='card'>
                  ...
                  <div class='card-body'>
                    <!-- .form -->
                    <?= form_open(base_url('Filho/update/'.$parentView.'/'.$IdParent.'/'.$response['data'][0]['pfo_Id'])); ?>
                      <!-- .fieldset -->
                      <fieldset>
                        <legend>Alteração do registro</legend> <!-- .form-group -->
							<div class='form-group'>
								<label for='pfo_PaiId'>Tabela Pai</label>
							<select name='pfo_PaiId' id='pfo_PaiId' class='custom-select' placeholder='Tabela Pai' required>
								<?= getOptionToSelect('pai','pp_Id', '', $response['data'][0]['pfo_PaiId'], $login->data->token) ?>
							</select>
							<?php if(isset($response)): ?>
							...
							<input type='text'  name='pfo_Nome' id='pfo_Nome' class='form-control' placeholder='Nome' value='<?= $response['data'][0]['pfo_Nome'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='text'  name='pfo_Sobrenome' id='pfo_Sobrenome' class='form-control' placeholder='Sobrenome' value='<?= $response['data'][0]['pfo_Sobrenome'] ?>' required>
							<?php if(isset($response)): ?>
