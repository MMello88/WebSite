...
var DTRegs0145efdc =
function () {
  function DTRegs0145efdc() {
    _classCallCheck(this, DTRegs0145efdc);
    this.init();
  }

  _createClass(DTRegs0145efdc, [{
    key: "init",
    value: function init() {
    ...
    value: function table() {
      return $('#myTableRegs0145efdc').DataTable({
        dom: "<'text-muted'Bi>\n        <'table-responsive'tr>\n        <'mt-4'p>",
        buttons: ['copyHtml5', {
          extend: 'print', 
          autoPrint: false
        ...
        columnDefs: [{
          ...
          render: function render(data, type, row, meta) {
            ...
            <div class='custom-control custom-control-nolabel custom-checkbox'>
              <input type='checkbox' class='custom-control-input' name='selectedRow[]' id='p${row['0145_Id']}' value='${row['0145_Id']}'>
              <label class='custom-control-label' for='p${row['0145_Id']}'></label>
            </div>`;
          }
        },{
          targets: 1,
    ...
    value: function clearSelected() {
      ...
      $('#myTableRegs0145efdc').on('page.dt', function () {
        self.clearSelectedRows();
      });
