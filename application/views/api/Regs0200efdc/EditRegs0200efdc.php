                    ...
                    <?= form_open(base_url('Regs0200efdc/update/'.$response['data'][0]['0200_Id'])); ?>
                      ...
                      <fieldset>
                        <legend>Alteração do registro</legend> <!-- .form-group -->
							...
							<input type='number' step='1' name='0200_CodGen' id='0200_CodGen' class='form-control' placeholder='Código Gênero Item' value='<?= $response['data'][0]['0200_CodGen'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='number' step='1' name='0200_CodLst' id='0200_CodLst' class='form-control' placeholder='Código do Serviço' value='<?= $response['data'][0]['0200_CodLst'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='number' step='0.01' name='0200_AliqIcms' id='0200_AliqIcms' class='form-control' placeholder='Alíquota de ICMS' value='<?= $response['data'][0]['0200_AliqIcms'] ?>' required>
							<?php if(isset($response)): ?>
