            ...
            <div class='page-section'>
              ...
              <div class='section-block'>            
                ...
                <div id='base-style' class='card'>
                  ...
                  <div class='card-body'>
                    <!-- .form -->
                    <?= form_open(base_url('Regsa001efdc/update/'.$response['data'][0]['a001_Id'])); ?>
                      <!-- .fieldset -->
                      <fieldset>
                        <legend>Alteração do registro</legend> <!-- .form-group -->
							...
							<select name='a001_IndicadorMovimento' id='a001_IndicadorMovimento' class='custom-select' placeholder='Indicador Movimento' required>
								...
								<option value='0 - Bloco com dados informados' <?= $response['data'][0]['a001_IndicadorMovimento'] == '0 - Bloco com dados informados' ? 'selected' : '' ?>> 0 - Bloco com dados informados </option>
								<option value='1 - Bloco sem dados informados' <?= $response['data'][0]['a001_IndicadorMovimento'] == '1 - Bloco sem dados informados' ? 'selected' : '' ?>> 1 - Bloco sem dados informados </option>
							</select>
						</div>
							<div class='form-group'>
							...
							<input type='number' name='a001_PessoaJuridicaId' id='a001_PessoaJuridicaId' class='form-control' placeholder='Pessoa Juridica' value='<?= $response['data'][0]['a001_PessoaJuridicaId'] ?>' >
							<?php if(isset($response)): ?>
...
<script>
  var url_get = '<?= base_url('regsa001efdc/get'); ?>';
