            ...
            <div class='page-section'>
              ...
              <div class='section-block'>            
                ...
                <div id='base-style' class='card'>
                  ...
                  <div class='card-body'>
                    <!-- .form -->
                    <?= form_open(base_url('Regs0111efdc/add')); ?>
                      <!-- .fieldset -->
                      <fieldset>
                        <legend>Adicionar um novo registro</legend> <!-- .form-group -->
							...
							<input type='number' step='1' name='0111_RecBruNCumTribMI' id='0111_RecBruNCumTribMI' class='form-control' placeholder='Tributada' value='<?= isset($response['data']['0111_RecBruNCumTribMI']) ? $response['data']['0111_RecBruNCumTribMI'] : '' ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='number' step='1' name='0111_RecBruNCumNaoTribMI' id='0111_RecBruNCumNaoTribMI' class='form-control' placeholder='Não Tributada' value='<?= isset($response['data']['0111_RecBruNCumNaoTribMI']) ? $response['data']['0111_RecBruNCumNaoTribMI'] : '' ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='number' step='1' name='0111_RecBruNCumExp' id='0111_RecBruNCumExp' class='form-control' placeholder='Exportação' value='<?= isset($response['data']['0111_RecBruNCumExp']) ? $response['data']['0111_RecBruNCumExp'] : '' ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='number' step='1' name='0111_RecBruNCum' id='0111_RecBruNCum' class='form-control' placeholder='Receita Bruta Cumulativa' value='<?= isset($response['data']['0111_RecBruNCum']) ? $response['data']['0111_RecBruNCum'] : '' ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='number' step='1' name='0111_RecBruNCumTotal' id='0111_RecBruNCumTotal' class='form-control' placeholder='Receita Bruta Total' value='<?= isset($response['data']['0111_RecBruNCumTotal']) ? $response['data']['0111_RecBruNCumTotal'] : '' ?>' required>
							<?php if(isset($response)): ?>
