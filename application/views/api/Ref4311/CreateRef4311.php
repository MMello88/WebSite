                    ...
                    <?= form_open(base_url('Ref4311/add')); ?>
                      ...
                      <fieldset>
                        <legend>Adicionar um novo registro</legend> <!-- .form-group -->
							...
							<input type='number' step='0.01' name='4311_AliqPis' id='4311_AliqPis' class='form-control' placeholder='Alíquota do PIS %' value='<?= isset($response['data']['4311_AliqPis']) ? $response['data']['4311_AliqPis'] : '' ?>' >
							<?php if(isset($response)): ?>
							...
							<input type='number' step='0.01' name='4311_AliqCofins' id='4311_AliqCofins' class='form-control' placeholder='Alíquota da COFINS %' value='<?= isset($response['data']['4311_AliqCofins']) ? $response['data']['4311_AliqCofins'] : '' ?>' >
							<?php if(isset($response)): ?>
