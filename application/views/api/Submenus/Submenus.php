                      ...
                      <div class='input-group-prepend'>
                        <select id='filterBy' class='custom-select'>
                          <option value='' selected> Filtrar por </option>
													<option value='0'> sbm_Id </option>
													<option value='1'> sbm_MenusId </option>
													<option value='2'> sbm_Nome </option>
													<option value='3'> sbm_Ativo </option>
													<option value='4'> sbm_Icone </option>
													<option value='5'> sbm_Url </option>
													<option value='6'> sbm_Nivel </option>
