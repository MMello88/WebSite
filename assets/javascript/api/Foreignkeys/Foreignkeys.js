...
var DTForeignkeys =
function () {
  function DTForeignkeys() {
    _classCallCheck(this, DTForeignkeys);
    this.init();
  }

  _createClass(DTForeignkeys, [{
    key: "init",
    value: function init() {
    ...
    value: function table() {
      return $('#myTableForeignkeys').DataTable({
        dom: "<'text-muted'Bi>\n        <'table-responsive'tr>\n        <'mt-4'p>",
        buttons: ['copyHtml5', {
          extend: 'print', 
          autoPrint: false
        ...
        columnDefs: [{
          ...
          render: function render(data, type, row, meta) {
            ...
            <div class='custom-control custom-control-nolabel custom-checkbox'>
              <input type='checkbox' class='custom-control-input' name='selectedRow[]' id='p${row['fks_Id']}' value='${row['fks_Id']}'>
              <label class='custom-control-label' for='p${row['fks_Id']}'></label>
            </div>`;
          }
        },{
          targets: 1,
    ...
    value: function clearSelected() {
      ...
      $('#myTableForeignkeys').on('page.dt', function () {
        self.clearSelectedRows();
      });
