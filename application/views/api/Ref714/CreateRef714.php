            ...
            <div class='page-section'>
              ...
              <div class='section-block'>            
                ...
                <div id='base-style' class='card'>
                  ...
                  <div class='card-body'>
                    <!-- .form -->
                    <?= form_open(base_url('Ref714/add')); ?>
                      <!-- .fieldset -->
                      <fieldset>
                        <legend>Adicionar um novo registro</legend> <!-- .form-group -->
							<div class='form-group'>
								<label for='714_Codigo'>Código</label>
							<input type='text' name='714_Codigo' id='714_Codigo' class='form-control' placeholder='Código' value='<?= isset($response['data']['714_Codigo']) ? $response['data']['714_Codigo'] : '' ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='714_Descricao' id='714_Descricao' class='form-control' placeholder='Descrição' value='<?= isset($response['data']['714_Descricao']) ? $response['data']['714_Descricao'] : '' ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='date' name='714_DtIni' id='714_DtIni' class='form-control' placeholder='Data Inicial' value='<?= isset($response['data']['714_DtIni']) ? $response['data']['714_DtIni'] : '' ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='date' name='714_DtFin' id='714_DtFin' class='form-control' placeholder='Data Final' value='<?= isset($response['data']['714_DtFin']) ? $response['data']['714_DtFin'] : '' ?>' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='714_IndTipoAtividade' id='714_IndTipoAtividade' class='form-control' placeholder='Indicador Tipo Atividade' value='<?= isset($response['data']['714_IndTipoAtividade']) ? $response['data']['714_IndTipoAtividade'] : '' ?>' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='714_IndAjuste' id='714_IndAjuste' class='form-control' placeholder='Indicador Ajuste' value='<?= isset($response['data']['714_IndAjuste']) ? $response['data']['714_IndAjuste'] : '' ?>' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='714_Grupo' id='714_Grupo' class='form-control' placeholder='Cód. Grupo' value='<?= isset($response['data']['714_Grupo']) ? $response['data']['714_Grupo'] : '' ?>' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='714_SubGrupo' id='714_SubGrupo' class='form-control' placeholder='Cód. SubGrupo' value='<?= isset($response['data']['714_SubGrupo']) ? $response['data']['714_SubGrupo'] : '' ?>' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='714_IndOutros' id='714_IndOutros' class='form-control' placeholder='Indicador Outros' value='<?= isset($response['data']['714_IndOutros']) ? $response['data']['714_IndOutros'] : '' ?>' >
							<?php if(isset($response)): ?>
...
<script>
  var url_get = '<?= base_url('ref714/create'); ?>';
