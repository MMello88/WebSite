...
var DT__efmigrationshistory =
function () {
  function DT__efmigrationshistory() {
    _classCallCheck(this, DT__efmigrationshistory);
    this.init();
  }

  _createClass(DT__efmigrationshistory, [{
    key: "init",
    value: function init() {
        ...
        columnDefs: [{
          ...
          render: function render(data, type, row, meta) {
            ...
            <div class='custom-control custom-control-nolabel custom-checkbox'>
              <input type='checkbox' class='custom-control-input' name='selectedRow[]' id='p${row['MigrationId']}' value='${row['MigrationId']}'>
              <label class='custom-control-label' for='p${row['MigrationId']}'></label>
            </div>`;
          }
        },{
          targets: 2,
  ...
  return DT__efmigrationshistory;
}();

$(document).on('theme:init', function () {
  new DT__efmigrationshistory();
});
