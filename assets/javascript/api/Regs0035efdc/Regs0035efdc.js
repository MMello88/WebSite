...
function () {
  ...
  _createClass(DTRegs0035efdc, [{
    ...
    value: function table() {
      return $('#myTableRegs0035efdc').DataTable({
        dom: "<'text-muted'Bi>\n        <'table-responsive'tr>\n        <'mt-4'p>",
        buttons: ['copyHtml5', {
          extend: 'print', 
          autoPrint: false
        ...
        columnDefs: [{
          ...
          render: function render(data, type, row, meta) {
            ...
            <div class='custom-control custom-control-nolabel custom-checkbox'>
              <input type='checkbox' class='custom-control-input' name='selectedRow[]' id='p${row['0035_Id']}' value='${row['0035_Id']}'>
              <label class='custom-control-label' for='p${row['0035_Id']}'></label>
            </div>`;
          }
        },{
          targets: 1,
    ...
    value: function clearSelected() {
      ...
      $('#myTableRegs0035efdc').on('page.dt', function () {
        self.clearSelectedRows();
      });
