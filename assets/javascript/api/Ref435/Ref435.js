...
function () {
  function DTRef435() {
    _classCallCheck(this, DTRef435);
    this.init();
  }

  _createClass(DTRef435, [{
    key: "init",
    value: function init() {
    ...
    value: function table() {
      return $('#myTableRef435').DataTable({
        dom: "<'text-muted'Bi>\n        <'table-responsive'tr>\n        <'mt-4'p>",
        buttons: ['copyHtml5', {
          extend: 'print', 
          autoPrint: false
        ...
        columnDefs: [{
          ...
          render: function render(data, type, row, meta) {
            ...
            <div class='custom-control custom-control-nolabel custom-checkbox'>
              <input type='checkbox' class='custom-control-input' name='selectedRow[]' id='p${row['435_Id']}' value='${row['435_Id']}'>
              <label class='custom-control-label' for='p${row['435_Id']}'></label>
            </div>`;
          }
        },{
          targets: 1,
    ...
    value: function clearSelected() {
      ...
      $('#myTableRef435').on('page.dt', function () {
        self.clearSelectedRows();
      });
