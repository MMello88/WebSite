    ...
    class Regs0140efdc extends MY_Controller {
      ...
      public function get(){
        echo json_encode(['data' => $this->sendGet('api/regs0140efdc/get', $this->data['login']->data->token)->data]);
      }
      ...
      public function add(){
        if($_POST){
          ...
          if($response['status'] == 'FALSE'){
            redirect('regs0140efdc/create');
          } else {
            $salvarEVoltar ? redirect('regs0140efdc') : redirect('regs0140efdc/edit/'.$response['data'][0]['0140_Id']);
          }
        }
      }
      ...
      public function update($Id){
        if($_POST){
          ...
          if($response['status'] == 'FALSE'){
            redirect('regs0140efdc/edit/'.$Id);
          } else {
            $salvarEVoltar ? redirect('regs0140efdc') : redirect('regs0140efdc/edit/'.$Id);
          }
        }
      }
