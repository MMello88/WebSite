                    ...
                    <?= form_open(base_url('Ref4316/add')); ?>
                      ...
                      <fieldset>
                        <legend>Adicionar um novo registro</legend> <!-- .form-group -->
							...
							<input type='text' name='4316_Codigo' id='4316_Codigo' class='form-control' placeholder='Código' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='4316_Descricao' id='4316_Descricao' class='form-control' placeholder='Descrição' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='date' name='4316_DtIni' id='4316_DtIni' class='form-control' placeholder='Data Inicial' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='date' name='4316_DtFin' id='4316_DtFin' class='form-control' placeholder='Data Final' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='4316_Ncm' id='4316_Ncm' class='form-control' placeholder='NCM' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='4316_NcmEx' id='4316_NcmEx' class='form-control' placeholder='Exceto NCM' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='4316_ExIpi' id='4316_ExIpi' class='form-control' placeholder='Código EX TIPI' value='' >
							<?php if(isset($response)): ?>
