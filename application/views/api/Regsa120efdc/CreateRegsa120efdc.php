                    ...
                    <?= form_open(base_url('Regsa120efdc/add/'.$parentView.'/'.$IdParent)); ?>
                      ...
                      <fieldset>
                        <legend>Adicionar um novo registro</legend> <!-- .form-group -->
							...
							<input type='number' step='0.01' name='a120_VlTotalServico' id='a120_VlTotalServico' class='form-control' placeholder='Valor Total do Serviço' value='<?= isset($response['data']['a120_VlTotalServico']) ? $response['data']['a120_VlTotalServico'] : '' ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='number' step='0.01' name='a120_VlBcPis' id='a120_VlBcPis' class='form-control' placeholder='Valor BC PIS' value='<?= isset($response['data']['a120_VlBcPis']) ? $response['data']['a120_VlBcPis'] : '' ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='number' step='0.01' name='a120_VlPisImportacao' id='a120_VlPisImportacao' class='form-control' placeholder='Valor Pago PIS' value='<?= isset($response['data']['a120_VlPisImportacao']) ? $response['data']['a120_VlPisImportacao'] : '' ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='number' step='0.01' name='a120_VlBcCofins' id='a120_VlBcCofins' class='form-control' placeholder='Valor BC COFINS' value='<?= isset($response['data']['a120_VlBcCofins']) ? $response['data']['a120_VlBcCofins'] : '' ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='number' step='0.01' name='a120_VlCofinsImportacao' id='a120_VlCofinsImportacao' class='form-control' placeholder='Valor Pago COFINS' value='<?= isset($response['data']['a120_VlCofinsImportacao']) ? $response['data']['a120_VlCofinsImportacao'] : '' ?>' required>
							<?php if(isset($response)): ?>
