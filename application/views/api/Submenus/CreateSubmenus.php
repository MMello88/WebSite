                    ...
                    <?= form_open(base_url('Submenus/add')); ?>
                      ...
                      <fieldset>
                        <legend>Adicionar um novo registro</legend> <!-- .form-group -->
							...
							<input type='number' name='sbm_MenusId' id='sbm_MenusId' class='form-control' placeholder='Menu' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='sbm_Nome' id='sbm_Nome' class='form-control' placeholder='Nome do Submenu' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='' name='sbm_Icone' id='sbm_Icone' class='form-control' placeholder='Icone' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='' name='sbm_Url' id='sbm_Url' class='form-control' placeholder='Url' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='number' name='sbm_Nivel' id='sbm_Nivel' class='form-control' placeholder='Nível' value='' >
							<?php if(isset($response)): ?>
...
<script>
  var url_get = '<?= base_url('submenus/create'); ?>';
