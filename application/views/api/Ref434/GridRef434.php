              ...
              <nav aria-label='breadcrumb'>
                <ol class='breadcrumb'>
                  <li class='breadcrumb-item active'>
                    <a href='#'><i class='breadcrumb-icon fa fa-angle-left mr-2'></i>Código da Situação Tributária Referente à Cofins</a>
                  </li>
                </ol>
              </nav><!-- /.breadcrumb -->
              <!-- floating action -->
              <button type='button' class='btn btn-success btn-floated' onclick="window.location.href='<?= base_url('Ref434/create') ?>'"><span class='fa fa-plus'></span></button> <!-- /floating action -->
            ...
            <div class='page-section'>
              ...
              <div class='card card-fluid'>
                ...
                <div class='card-header d-md-flex align-items-md-start'>
                  <h1 class='page-title mr-sm-auto'> Código da Situação Tributária Referente à Cofins </h1><!-- .btn-toolbar -->
                ...
                <div class='card-body'>
                  ...
                  <!-- .table -->
                  <table id='myTableRef434' class='table'>
                    <!-- thead -->
                    <thead>
                      <tr>
                        <th>
    ...
    <title>Código da Situação Tributária Referente à Cofins</title>
<script>
