                    ...
                    <!-- .form -->
                      ...
                      <fieldset>
                        <legend>Alteração do registro</legend> <!-- .form-group -->
							...
							<input type='number' name='0145_CodIncTrib' id='0145_CodIncTrib' class='form-control' placeholder='Código Incidência Tributária' value='<?= isset($response['data'][0]['0145_CodIncTrib']) ? $response['data'][0]['0145_CodIncTrib'] : '' ?>' required disabled>
							<?php if(isset($response)): ?>
							...
							<input type='' name='0145_VlRecTot' id='0145_VlRecTot' class='form-control' placeholder='Valor da Receita Bruta Total' value='<?= isset($response['data'][0]['0145_VlRecTot']) ? $response['data'][0]['0145_VlRecTot'] : '' ?>' required disabled>
							<?php if(isset($response)): ?>
							...
							<input type='' name='0145_VlRecAtiv' id='0145_VlRecAtiv' class='form-control' placeholder='Valor da Receita Bruta da Atividade' value='<?= isset($response['data'][0]['0145_VlRecAtiv']) ? $response['data'][0]['0145_VlRecAtiv'] : '' ?>' required disabled>
							<?php if(isset($response)): ?>
							...
							<input type='' name='0145_VlRecDemaisAtiv' id='0145_VlRecDemaisAtiv' class='form-control' placeholder='Valor da Receita Bruta das demais Atividade' value='<?= isset($response['data'][0]['0145_VlRecDemaisAtiv']) ? $response['data'][0]['0145_VlRecDemaisAtiv'] : '' ?>' required disabled>
							<?php if(isset($response)): ?>
