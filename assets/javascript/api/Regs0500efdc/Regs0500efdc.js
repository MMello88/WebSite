...
var DTRegs0500efdc =
function () {
  function DTRegs0500efdc() {
    _classCallCheck(this, DTRegs0500efdc);
    this.init();
  }

  _createClass(DTRegs0500efdc, [{
    key: "init",
    value: function init() {
    ...
    value: function table() {
      return $('#myTableRegs0500efdc').DataTable({
        dom: "<'text-muted'Bi>\n        <'table-responsive'tr>\n        <'mt-4'p>",
        buttons: ['copyHtml5', {
          extend: 'print', 
          autoPrint: false
    ...
    value: function clearSelected() {
      ...
      $('#myTableRegs0500efdc').on('page.dt', function () {
        self.clearSelectedRows();
      });
