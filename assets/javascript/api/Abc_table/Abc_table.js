...
var DTAbc_table =
function () {
  function DTAbc_table() {
    _classCallCheck(this, DTAbc_table);
    this.init();
  }

  _createClass(DTAbc_table, [{
    key: "init",
    value: function init() {
        ...
        columnDefs: [{
          ...
          render: function render(data, type, row, meta) {
            ...
            <div class='custom-control custom-control-nolabel custom-checkbox'>
              <input type='checkbox' class='custom-control-input' name='selectedRow[]' id='p${row['abc_Id']}' value='${row['abc_Id']}'>
              <label class='custom-control-label' for='p${row['abc_Id']}'></label>
            </div>`;
          }
        },{
          targets: 1,
