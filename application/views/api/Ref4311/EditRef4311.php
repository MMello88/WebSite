            ...
            <div class='page-section'>
              ...
              <div class='section-block'>            
                ...
                <div id='base-style' class='card'>
                  ...
                  <div class='card-body'>
                    <!-- .form -->
                    <?= form_open(base_url('Ref4311/update/'.$response['data'][0]['4311_Id'])); ?>
                      <!-- .fieldset -->
                      <fieldset>
                        <legend>Alteração do registro</legend> <!-- .form-group -->
							<div class='form-group'>
								<label for='4311_Codigo'>Código</label>
							<input type='text'  name='4311_Codigo' id='4311_Codigo' class='form-control' placeholder='Código' value='<?= $response['data'][0]['4311_Codigo'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='text'  name='4311_Descricao' id='4311_Descricao' class='form-control' placeholder='Descrição' value='<?= $response['data'][0]['4311_Descricao'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='date'  name='4311_DtIni' id='4311_DtIni' class='form-control' placeholder='Data Inicial' value='<?= $response['data'][0]['4311_DtIni'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='date'  name='4311_DtFin' id='4311_DtFin' class='form-control' placeholder='Data Final' value='<?= $response['data'][0]['4311_DtFin'] ?>' >
							<?php if(isset($response)): ?>
							...
							<input type='text'  name='4311_Ncm' id='4311_Ncm' class='form-control' placeholder='NCM' value='<?= $response['data'][0]['4311_Ncm'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='text'  name='4311_NcmEx' id='4311_NcmEx' class='form-control' placeholder='Exceto NCM' value='<?= $response['data'][0]['4311_NcmEx'] ?>' >
							<?php if(isset($response)): ?>
							...
							<input type='text'  name='4311_ExIpi' id='4311_ExIpi' class='form-control' placeholder='Código EX TIPI' value='<?= $response['data'][0]['4311_ExIpi'] ?>' >
							<?php if(isset($response)): ?>
							...
							<input type='text'  name='4311_Unid' id='4311_Unid' class='form-control' placeholder='Unidade' value='<?= $response['data'][0]['4311_Unid'] ?>' >
							<?php if(isset($response)): ?>
							...
							<input type='number' step='0.01' name='4311_AliqPis' id='4311_AliqPis' class='form-control' placeholder='Alíquota do PIS %' value='<?= $response['data'][0]['4311_AliqPis'] ?>' >
							<?php if(isset($response)): ?>
							...
							<input type='number' step='0.01' name='4311_AliqCofins' id='4311_AliqCofins' class='form-control' placeholder='Alíquota da COFINS %' value='<?= $response['data'][0]['4311_AliqCofins'] ?>' >
							<?php if(isset($response)): ?>
