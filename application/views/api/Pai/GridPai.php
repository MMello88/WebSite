              ...
              <nav aria-label='breadcrumb'>
                <ol class='breadcrumb'>
                  <li class='breadcrumb-item active'>
                    <a href='#'><i class='breadcrumb-icon fa fa-angle-left mr-2'></i>Tabela Pai</a>
                  </li>
                </ol>
              </nav><!-- /.breadcrumb -->
              <!-- floating action -->
              <button type='button' class='btn btn-success btn-floated' onclick="window.location.href='<?= base_url('Pai/create') ?>'"><span class='fa fa-plus'></span></button> <!-- /floating action -->
            ...
            <div class='page-section'>
              ...
              <div class='card card-fluid'>
                ...
                <div class='card-header d-md-flex align-items-md-start'>
                  <h1 class='page-title mr-sm-auto'> Tabela Pai </h1><!-- .btn-toolbar -->
                ...
                <div class='card-body'>
                      ...
                      <div class='input-group-prepend'>
                        <select id='filterBy' class='custom-select' style='width: 150px'>
                          <option value='' selected> Filtrar por </option>
													...
													<option value='2'> Modelos de Documentos Fiscais </option>
                  ...
                  <!-- .table -->
                  <table id='myTablePai' class='table'>
                    <!-- thead -->
                    <thead>
                      <tr>
                        <th>
                          <div class='thead-dd dropdown'>
                            ...
                            <div class='dropdown-menu'>
                              ...
                              <a class='dropdown-item' href='#'>Separate actions</a>
												...
												<th> Nome </th>
												<th> Modelos de Documentos Fiscais </th>
												<th> Usuário </th>
...
<script>
var url_get = '<?= base_url('pai/get'); ?>';
var url_upd = '<?= base_url('pai/edit'); ?>';
var url_view = '<?= base_url('pai/view'); ?>';
</script>
