              ...
              <nav aria-label='breadcrumb'>
                <ol class='breadcrumb'>
                  <li class='breadcrumb-item active'>
                    <a href='#'><i class='breadcrumb-icon fa fa-angle-left mr-2'></i>Produtos Sujeitos a Alíquotas Diferenciadas</a>
                  </li>
                </ol>
              </nav><!-- /.breadcrumb -->
              <!-- floating action -->
            ...
            <div class='page-section'>
              ...
              <div class='card card-fluid'>
                ...
                <div class='card-header d-md-flex align-items-md-start'>
                  <h1 class='page-title mr-sm-auto'> Produtos Sujeitos a Alíquotas Diferenciadas </h1><!-- .btn-toolbar -->
                      ...
                      <div class='input-group-prepend'>
                        <select id='filterBy' class='custom-select'>
                          <option value='' selected> Filtrar por </option>
													<option value='0'> 4310_Id </option>
													<option value='1'> 4310_Codigo </option>
													<option value='2'> 4310_Descricao </option>
													<option value='3'> 4310_DtIni </option>
													<option value='4'> 4310_DtFin </option>
													<option value='5'> 4310_Ncm </option>
													<option value='6'> 4310_NcmEx </option>
													<option value='7'> 4310_ExIpi </option>
													<option value='8'> 4310_AliqPis </option>
													<option value='9'> 4310_AliqCofins </option>
    ...
    <title>Produtos Sujeitos a Alíquotas Diferenciadas</title>
<script>
