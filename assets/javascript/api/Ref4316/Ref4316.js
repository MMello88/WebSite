...
function () {
  function DTRef4316() {
    _classCallCheck(this, DTRef4316);
    this.init();
  }

  _createClass(DTRef4316, [{
    key: "init",
    value: function init() {
    ...
    value: function table() {
      return $('#myTableRef4316').DataTable({
        dom: "<'text-muted'Bi>\n        <'table-responsive'tr>\n        <'mt-4'p>",
        buttons: ['copyHtml5', {
          extend: 'print', 
          autoPrint: false
        ...
        columnDefs: [{
          ...
          render: function render(data, type, row, meta) {
            ...
            <div class='custom-control custom-control-nolabel custom-checkbox'>
              <input type='checkbox' class='custom-control-input' name='selectedRow[]' id='p${row['4316_Id']}' value='${row['4316_Id']}'>
              <label class='custom-control-label' for='p${row['4316_Id']}'></label>
            </div>`;
          }
        },{
          targets: 1,
    ...
    value: function clearSelected() {
      ...
      $('#myTableRef4316').on('page.dt', function () {
        self.clearSelectedRows();
      });
