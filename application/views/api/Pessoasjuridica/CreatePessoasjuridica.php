              ...
              <nav aria-label='breadcrumb'>
                <ol class='breadcrumb'>
                  <li class='breadcrumb-item active'>
                    <a href='<?= base_url('Pessoasfisica/'.$parentView.'/'.$IdParent) ?>'><i class='breadcrumb-icon fa fa-angle-left mr-2'></i>Voltar Matheus</a>
                  </li>
                </ol>
              </nav><!-- /.breadcrumb -->
            ...
            <div class='page-section'>
              ...
              <div class='section-block'>            
                ...
                <div id='base-style' class='card'>
                  ...
                  <div class='card-body'>
                    <!-- .form -->
                    <?= form_open(base_url('Pessoasjuridica/add/'.$parentView.'/'.$IdParent)); ?>
                      <!-- .fieldset -->
                      <fieldset>
                        <legend>Adicionar um novo registro</legend> <!-- .form-group -->
							...
							<input type='number' step='1' name='pj_Matriz' id='pj_Matriz' class='form-control' placeholder='Matriz' value='<?= isset($response['data']['pj_Matriz']) ? $response['data']['pj_Matriz'] : '0' ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='number' step='1' name='pj_NaturezaJuridica' id='pj_NaturezaJuridica' class='form-control' placeholder='Natureza Juridica' value='<?= isset($response['data']['pj_NaturezaJuridica']) ? $response['data']['pj_NaturezaJuridica'] : '' ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='number' step='1' name='pj_DmContribuicao' id='pj_DmContribuicao' class='form-control' placeholder='Contribuinte' value='<?= isset($response['data']['pj_DmContribuicao']) ? $response['data']['pj_DmContribuicao'] : '0' ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='hidden' name='pj_PessoaFisicaId' value='<?= $IdParent ?>' required>
							<select name='pj_PessoaFisicaId' id='pj_PessoaFisicaId' class='custom-select' placeholder='Pessoa Fisica' required disabled>
								<?= getOptionToSelect('pessoasfisica','pf_Id', '', $IdParent, $login->data->token) ?>
							</select>
							<?php if(isset($response)): ?>
                        ...
                        <div class='form-actions'>
                          ...
                          <button class='btn btn-secondary ml-auto' type='button' onclick="window.location.href='<?= base_url('Pessoasfisica/'.$parentView.'/'.$IdParent) ?>'">Cancelar</button>
                        </div>
                      </fieldset><!-- /.fieldset -->
                    <?= form_close(); ?><!-- /.form -->
                  </div><!-- /.card-body -->
