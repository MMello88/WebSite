...
var DTRegsa120efdc =
function () {
  function DTRegsa120efdc() {
    _classCallCheck(this, DTRegsa120efdc);
    this.init();
  }

  _createClass(DTRegsa120efdc, [{
    key: "init",
    value: function init() {
    ...
    value: function table() {
      return $('#myTableRegsa120efdc').DataTable({
        dom: "<'text-muted'Bi>\n        <'table-responsive'tr>\n        <'mt-4'p>",
        buttons: ['copyHtml5', {
          extend: 'print', 
          autoPrint: false
        ...
        columns: [
				...
				{
					data: 'a120_VlPisImportacao',
					className: 'align-middle',
				},
				{
					data: 'a120_DtPgtoPisImportacao',
					className: 'align-middle',
				},
				{
					data: 'a120_VlBcCofins',
					className: 'align-middle',
				},
				{
					data: 'a120_VlCofinsImportacao',
					className: 'align-middle',
				},
				{
					data: 'a120_DtPgtoCofinsImportacao',
					className: 'align-middle',
				},
				{
					data: 'a120_IndicadorLocalExecucaoServico',
					className: 'align-middle',
				},
				{
					data: 'a120_RegA100EFDCId',
					className: 'align-middle',
				},
				{
					data: 'a120_UsersId',
        ...
        columnDefs: [{
          ...
          render: function render(data, type, row, meta) {
            ...
            <div class='custom-control custom-control-nolabel custom-checkbox'>
              <input type='checkbox' class='custom-control-input' name='selectedRow[]' id='p${row['a120_Id']}' value='${row['a120_Id']}'>
              <label class='custom-control-label' for='p${row['a120_Id']}'></label>
            </div>`;
          }
        },{
          targets: 1,
          render: function render(data, type, row, meta) {
            return `
            <a class='btn btn-sm btn-icon btn-secondary' href='${url_view_regsa120efdc}/${data}'>
              <i class='fa fa-eye'></i>
            </a>
    ...
    value: function clearSelected() {
      ...
      $('#myTableRegsa120efdc').on('page.dt', function () {
        self.clearSelectedRows();
      });
