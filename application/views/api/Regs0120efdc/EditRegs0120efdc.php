                    ...
                    <?= form_open(base_url('Regs0120efdc/update/'.$response['data'][0]['0120_Id'])); ?>
                      ...
                      <fieldset>
                        <legend>Alteração do registro</legend> <!-- .form-group -->
							...
							<input type='number' name='0120_InfoCompl' id='0120_InfoCompl' class='form-control' placeholder='Informação complementar' value='<?= $response['data'][0]['0120_InfoCompl'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='number' name='0120_PessoaJuridicaId' id='0120_PessoaJuridicaId' class='form-control' placeholder='Pessoa Juridica' value='<?= $response['data'][0]['0120_PessoaJuridicaId'] ?>' >
							<?php if(isset($response)): ?>
