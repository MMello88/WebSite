                      ...
                      <div class='input-group-prepend'>
                        <select id='filterBy' class='custom-select'>
                          <option value='' selected> Filtrar por </option>
													<option value='0'> 4316_Id </option>
													<option value='1'> 4316_Codigo </option>
													<option value='2'> 4316_Descricao </option>
													<option value='3'> 4316_DtIni </option>
													<option value='4'> 4316_DtFin </option>
													<option value='5'> 4316_Ncm </option>
													<option value='6'> 4316_NcmEx </option>
													<option value='7'> 4316_ExIpi </option>
