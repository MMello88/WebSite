...
var DTRegs0200efdc =
function () {
  function DTRegs0200efdc() {
    _classCallCheck(this, DTRegs0200efdc);
    this.init();
  }

  _createClass(DTRegs0200efdc, [{
    key: "init",
    value: function init() {
    ...
    value: function table() {
      return $('#myTableRegs0200efdc').DataTable({
        dom: "<'text-muted'Bi>\n        <'table-responsive'tr>\n        <'mt-4'p>",
        buttons: ['copyHtml5', {
          extend: 'print', 
          autoPrint: false
    ...
    value: function clearSelected() {
      ...
      $('#myTableRegs0200efdc').on('page.dt', function () {
        self.clearSelectedRows();
      });
