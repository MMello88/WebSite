            ...
            <div class='page-section'>
              ...
              <div class='section-block'>            
                ...
                <div id='base-style' class='card'>
                  ...
                  <div class='card-body'>
                    <!-- .form -->
                    <?= form_open(base_url('Regs0110efdc/update/'.$parentView.'/'.$IdParent.'/'.$response['data'][0]['0110_Id'])); ?>
                      <!-- .fieldset -->
                      <fieldset>
                        <legend>Alteração do registro</legend> <!-- .form-group -->
							...
							<select name='0110_PessoaJuridicaId' id='0110_PessoaJuridicaId' class='custom-select' placeholder='Pessoa Juridica' >
								<?= getOptionToSelect('pessoasjuridica','pj_Id', '', $response['data'][0]['0110_PessoaJuridicaId'], $login->data->token) ?>
							</select>
							<?php if(isset($response)): ?>
							...
							<select name='0110_Reg0111EFDCId' id='0110_Reg0111EFDCId' class='custom-select' placeholder='' >
								<?= getOptionToSelect('regs0111efdc','0111_Id', '', $response['data'][0]['0110_Reg0111EFDCId'], $login->data->token) ?>
							</select>
							<?php if(isset($response)): ?>
