              ...
              <nav aria-label='breadcrumb'>
                <ol class='breadcrumb'>
                  <li class='breadcrumb-item active'>
                    <a href='#'><i class='breadcrumb-icon fa fa-angle-left mr-2'></i>Produtos Sujeitos à Substituição Tributária da Contribuição Social</a>
                  </li>
                </ol>
              </nav><!-- /.breadcrumb -->
              <!-- floating action -->
            ...
            <div class='page-section'>
              ...
              <div class='card card-fluid'>
                ...
                <div class='card-header d-md-flex align-items-md-start'>
                  <h1 class='page-title mr-sm-auto'> Produtos Sujeitos à Substituição Tributária da Contribuição Social </h1><!-- .btn-toolbar -->
                      ...
                      <div class='input-group-prepend'>
                        <select id='filterBy' class='custom-select'>
                          <option value='' selected> Filtrar por </option>
													<option value='0'> 4312_Id </option>
													<option value='1'> 4312_Codigo </option>
													<option value='2'> 4312_Descricao </option>
													<option value='3'> 4312_DtIni </option>
													<option value='4'> 4312_DtFin </option>
													<option value='5'> 4312_Ncm </option>
													<option value='6'> 4312_NcmEx </option>
													<option value='7'> 4312_ExIpi </option>
													<option value='8'> 4312_AliqPis </option>
													<option value='9'> 4312_AliqCofins </option>
    ...
    <title>Produtos Sujeitos à Substituição Tributária da Contribuição Social</title>
<script>
