                    ...
                    <?= form_open(base_url('Regs0500efdc/add')); ?>
                      ...
                      <fieldset>
                        <legend>Adicionar um novo registro</legend> <!-- .form-group -->
							...
							<input type='datetime-local'  name='0500_DtAlteracao' id='0500_DtAlteracao' class='form-control' placeholder='Data Alteração' value='<?= isset($response['data']['0500_DtAlteracao']) ? (substr($response['data']['0500_DtAlteracao'],10,1) !== 'T' ? date_format(date_create_from_format('Y-m-d H:i:s', $response['data']['0500_DtAlteracao']),'Y-m-d\TH:i') : $response['data']['0500_DtAlteracao']) : '' ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='number' step='1' name='0500_Nivel' id='0500_Nivel' class='form-control' placeholder='Nível' value='<?= isset($response['data']['0500_Nivel']) ? $response['data']['0500_Nivel'] : '' ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='number' step='1' name='0500_CNPJEstab' id='0500_CNPJEstab' class='form-control' placeholder='CNPJ do estabelecimento' value='<?= isset($response['data']['0500_CNPJEstab']) ? $response['data']['0500_CNPJEstab'] : '' ?>' required>
							<?php if(isset($response)): ?>
