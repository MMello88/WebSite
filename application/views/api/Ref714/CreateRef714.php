                    ...
                    <?= form_open(base_url('Ref714/add')); ?>
                      ...
                      <fieldset>
                        <legend>Adicionar um novo registro</legend> <!-- .form-group -->
							...
							<input type='text' name='714_Codigo' id='714_Codigo' class='form-control' placeholder='Código' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='714_Descricao' id='714_Descricao' class='form-control' placeholder='Descrição' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='date' name='714_DtIni' id='714_DtIni' class='form-control' placeholder='Data Inicial' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='date' name='714_DtFin' id='714_DtFin' class='form-control' placeholder='Data Final' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='714_IndTipoAtividade' id='714_IndTipoAtividade' class='form-control' placeholder='Indicador Tipo Atividade' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='714_IndAjuste' id='714_IndAjuste' class='form-control' placeholder='Indicador Ajuste' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='714_Grupo' id='714_Grupo' class='form-control' placeholder='Cód. Grupo' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='714_SubGrupo' id='714_SubGrupo' class='form-control' placeholder='Cód. SubGrupo' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='714_IndOutros' id='714_IndOutros' class='form-control' placeholder='Indicador Outros' value='' >
							<?php if(isset($response)): ?>
