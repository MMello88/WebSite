                    ...
                    <?= form_open(base_url('Ref4311/update/'.$response['data'][0]['4311_Id'])); ?>
                      ...
                      <fieldset>
                        <legend>Alteração do registro</legend> <!-- .form-group -->
							...
							<input type='number' name='4311_AliqPis' id='4311_AliqPis' class='form-control' placeholder='Alíquota do PIS %' value='<?= $response['data'][0]['4311_AliqPis'] ?>' >
							<?php if(isset($response)): ?>
							...
							<input type='number' name='4311_AliqCofins' id='4311_AliqCofins' class='form-control' placeholder='Alíquota da COFINS %' value='<?= $response['data'][0]['4311_AliqCofins'] ?>' >
							<?php if(isset($response)): ?>
