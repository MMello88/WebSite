            ...
            <div class='page-section'>
              ...
              <div class='section-block'>            
                ...
                <div id='base-style' class='card'>
                  ...
                  <div class='card-body'>
                    <!-- .form -->
                    <?= form_open(base_url('Ref4314/update/'.$response['data'][0]['4314_Id'])); ?>
                      <!-- .fieldset -->
                      <fieldset>
                        <legend>Alteração do registro</legend> <!-- .form-group -->
							<div class='form-group'>
								<label for='4314_Codigo'>Código</label>
							<input type='text' name='4314_Codigo' id='4314_Codigo' class='form-control' placeholder='Código' value='<?= $response['data'][0]['4314_Codigo'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='4314_Descricao' id='4314_Descricao' class='form-control' placeholder='Descrição' value='<?= $response['data'][0]['4314_Descricao'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='date' name='4314_DtIni' id='4314_DtIni' class='form-control' placeholder='Data Inicial' value='<?= $response['data'][0]['4314_DtIni'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='date' name='4314_DtFin' id='4314_DtFin' class='form-control' placeholder='Data Final' value='<?= $response['data'][0]['4314_DtFin'] ?>' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='4314_Ncm' id='4314_Ncm' class='form-control' placeholder='NCM' value='<?= $response['data'][0]['4314_Ncm'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='4314_NcmEx' id='4314_NcmEx' class='form-control' placeholder='Exceto NCM' value='<?= $response['data'][0]['4314_NcmEx'] ?>' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='4314_ExIpi' id='4314_ExIpi' class='form-control' placeholder='Código EX TIPI' value='<?= $response['data'][0]['4314_ExIpi'] ?>' >
							<?php if(isset($response)): ?>
...
<script>
  var url_get = '<?= base_url('ref4314/get'); ?>';
  var url_upd = '<?= base_url('ref4314/edit'); ?>';
  var url_view = '<?= base_url('ref4314/view'); ?>';
</script>
