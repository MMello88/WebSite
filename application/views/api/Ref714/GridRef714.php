        ...
        <?php endif; ?>
          ...
          <div class='page-inner'>
            ...
            <header class='page-title-bar'>
              ...
              <!-- floating action -->
              <button type='button' class='btn btn-success btn-floated' onclick="window.location.href='<?= base_url('Ref714/create') ?>'"><span class='fa fa-plus'></span></button> <!-- /floating action -->
            ...
            <div class='page-section'>
              ...
              <div class='card card-fluid'>
                ...
                <div class='card-body'>
                      ...
                      <div class='input-group-prepend'>
                        <select id='filterBy' class='custom-select' style='width: 150px'>
                          <option value='' selected> Filtrar por </option>
													...
													<option value='8'> Cód. SubGrupo </option>
													<option value='9'> Indicador Outros </option>
                  ...
                  <!-- .table -->
                  <table id='myTableRef714' class='table'>
                    <!-- thead -->
                    <thead>
                      <tr>
                        <th>
