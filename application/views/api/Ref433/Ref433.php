                      ...
                      <div class='input-group-prepend'>
                        <select id='filterBy' class='custom-select'>
                          <option value='' selected> Filtrar por </option>
													<option value='0'> 433_Id </option>
													<option value='1'> 433_Codigo </option>
													<option value='2'> 433_Descricao </option>
													<option value='3'> 433_DtIni </option>
													<option value='4'> 433_DtFin </option>
