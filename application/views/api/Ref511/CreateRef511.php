                    ...
                    <?= form_open(base_url('Ref511/add')); ?>
                      ...
                      <fieldset>
                        <legend>Adicionar um novo registro</legend> <!-- .form-group -->
							...
							<input type='number' step='0.01' name='511_AliqAtividade' id='511_AliqAtividade' class='form-control' placeholder='Aliquota Atividade' value='<?= isset($response['data']['511_AliqAtividade']) ? $response['data']['511_AliqAtividade'] : '' ?>' >
							<?php if(isset($response)): ?>
