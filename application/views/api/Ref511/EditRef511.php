            ...
            <div class='page-section'>
              ...
              <div class='section-block'>            
                ...
                <div id='base-style' class='card'>
                  ...
                  <div class='card-body'>
                    <!-- .form -->
                    <?= form_open(base_url('Ref511/update/'.$response['data'][0]['511_Id'])); ?>
                      <!-- .fieldset -->
                      <fieldset>
                        <legend>Alteração do registro</legend> <!-- .form-group -->
							<div class='form-group'>
								<label for='511_Codigo'>Código</label>
							<input type='text'  name='511_Codigo' id='511_Codigo' class='form-control' placeholder='Código' value='<?= $response['data'][0]['511_Codigo'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='text'  name='511_Descricao' id='511_Descricao' class='form-control' placeholder='Descrição' value='<?= $response['data'][0]['511_Descricao'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='date'  name='511_DtIni' id='511_DtIni' class='form-control' placeholder='Data Inicial' value='<?= $response['data'][0]['511_DtIni'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='date'  name='511_DtFin' id='511_DtFin' class='form-control' placeholder='Data Final' value='<?= $response['data'][0]['511_DtFin'] ?>' >
							<?php if(isset($response)): ?>
							...
							<input type='text'  name='511_IndNcmAtividade' id='511_IndNcmAtividade' class='form-control' placeholder='NCM Atividade' value='<?= $response['data'][0]['511_IndNcmAtividade'] ?>' >
							<?php if(isset($response)): ?>
							...
							<input type='number' step='0.01' name='511_AliqAtividade' id='511_AliqAtividade' class='form-control' placeholder='Aliquota Atividade' value='<?= $response['data'][0]['511_AliqAtividade'] ?>' >
							<?php if(isset($response)): ?>
