              ...
              <nav aria-label='breadcrumb'>
                <ol class='breadcrumb'>
                  <li class='breadcrumb-item active'>
                    <a href='#'><i class='breadcrumb-icon fa fa-angle-left mr-2'></i></a>
                  </li>
                </ol>
              </nav><!-- /.breadcrumb -->
              <!-- floating action -->
              <button type='button' class='btn btn-success btn-floated' onclick="window.location.href='<?= base_url('Foreignkeys/create') ?>'"><span class='fa fa-plus'></span></button> <!-- /floating action -->
            ...
            <div class='page-section'>
              ...
              <div class='card card-fluid'>
                ...
                <div class='card-body'>
                  ...
                  <!-- .table -->
                  <table id='myTableForeignkeys' class='table'>
                    <!-- thead -->
                    <thead>
                      <tr>
                        <th>
