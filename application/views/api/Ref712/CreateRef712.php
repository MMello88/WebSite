                    ...
                    <?= form_open(base_url('Ref712/add')); ?>
                      ...
                      <fieldset>
                        <legend>Adicionar um novo registro</legend> <!-- .form-group -->
							...
							<input type='text' name='712_Codigo' id='712_Codigo' class='form-control' placeholder='Código' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='712_Descricao' id='712_Descricao' class='form-control' placeholder='Descrição' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='date' name='712_DtIni' id='712_DtIni' class='form-control' placeholder='Data Inicial' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='date' name='712_DtFin' id='712_DtFin' class='form-control' placeholder='Data Final' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='712_IndTipoAtividade' id='712_IndTipoAtividade' class='form-control' placeholder='Indicador Tipo Atividade' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='712_IndAjuste' id='712_IndAjuste' class='form-control' placeholder='Indicador Ajuste' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='712_Grupo' id='712_Grupo' class='form-control' placeholder='Cód. Grupo' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='712_IndOutros' id='712_IndOutros' class='form-control' placeholder='Indicador Outros' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='712_IndTipoDeducoes' id='712_IndTipoDeducoes' class='form-control' placeholder='Geral/Específica' value='' >
							<?php if(isset($response)): ?>
...
<script>
  var url_get = '<?= base_url('ref712/create'); ?>';
