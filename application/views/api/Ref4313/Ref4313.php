                      ...
                      <div class='input-group-prepend'>
                        <select id='filterBy' class='custom-select'>
                          <option value='' selected> Filtrar por </option>
													<option value='0'> 4313_Id </option>
													<option value='1'> 4313_Codigo </option>
													<option value='2'> 4313_Descricao </option>
													<option value='3'> 4313_DtIni </option>
													<option value='4'> 4313_DtFin </option>
													<option value='5'> 4313_Ncm </option>
													<option value='6'> 4313_NcmEx </option>
													<option value='7'> 4313_ExIpi </option>
