                    ...
                    <?= form_open(base_url('Ref4312/add')); ?>
                      ...
                      <fieldset>
                        <legend>Adicionar um novo registro</legend> <!-- .form-group -->
							...
							<input type='number' step='0.01' name='4312_AliqPis' id='4312_AliqPis' class='form-control' placeholder='Alíquota do PIS %' value='<?= isset($response['data']['4312_AliqPis']) ? $response['data']['4312_AliqPis'] : '' ?>' >
							<?php if(isset($response)): ?>
							...
							<input type='number' step='0.01' name='4312_AliqCofins' id='4312_AliqCofins' class='form-control' placeholder='Alíquota da COFINS %' value='<?= isset($response['data']['4312_AliqCofins']) ? $response['data']['4312_AliqCofins'] : '' ?>' >
							<?php if(isset($response)): ?>
