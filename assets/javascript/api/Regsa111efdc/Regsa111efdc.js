...
var DTRegsa111efdc =
function () {
  function DTRegsa111efdc() {
    _classCallCheck(this, DTRegsa111efdc);
    this.init();
  }

  _createClass(DTRegsa111efdc, [{
    key: "init",
    value: function init() {
    ...
    value: function table() {
      return $('#myTableRegsa111efdc').DataTable({
        dom: "<'text-muted'Bi>\n        <'table-responsive'tr>\n        <'mt-4'p>",
        buttons: ['copyHtml5', {
          extend: 'print', 
          autoPrint: false
        ...
        columns: [
				...
				{
					data: 'a111_NumProcesso',
					className: 'align-middle',
				},
				{
					data: 'a111_IndicadorOrigemProcesso',
					className: 'align-middle',
				},
				{
					data: 'a111_RegA100EFDCId',
					className: 'align-middle',
				},
				{
					data: 'a111_UsersId',
        ...
        columnDefs: [{
          ...
          render: function render(data, type, row, meta) {
            ...
            <div class='custom-control custom-control-nolabel custom-checkbox'>
              <input type='checkbox' class='custom-control-input' name='selectedRow[]' id='p${row['a111_Id']}' value='${row['a111_Id']}'>
              <label class='custom-control-label' for='p${row['a111_Id']}'></label>
            </div>`;
          }
        },{
          targets: 1,
    ...
    value: function clearSelected() {
      ...
      $('#myTableRegsa111efdc').on('page.dt', function () {
        self.clearSelectedRows();
      });
