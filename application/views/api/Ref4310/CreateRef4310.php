                    ...
                    <?= form_open(base_url('Ref4310/add')); ?>
                      ...
                      <fieldset>
                        <legend>Adicionar um novo registro</legend> <!-- .form-group -->
							...
							<input type='text' name='4310_Codigo' id='4310_Codigo' class='form-control' placeholder='Código' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='4310_Descricao' id='4310_Descricao' class='form-control' placeholder='Descrição' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='date' name='4310_DtIni' id='4310_DtIni' class='form-control' placeholder='Data Inicial' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='date' name='4310_DtFin' id='4310_DtFin' class='form-control' placeholder='Data Final' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='4310_Ncm' id='4310_Ncm' class='form-control' placeholder='NCM' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='4310_NcmEx' id='4310_NcmEx' class='form-control' placeholder='Exceto NCM' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='4310_ExIpi' id='4310_ExIpi' class='form-control' placeholder='Código EX TIPI' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='number' name='4310_AliqPis' id='4310_AliqPis' class='form-control' placeholder='Alíquota do PIS %' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='number' name='4310_AliqCofins' id='4310_AliqCofins' class='form-control' placeholder='Alíquota da COFINS %' value='' required>
							<?php if(isset($response)): ?>
