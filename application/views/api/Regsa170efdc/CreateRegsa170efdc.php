                    ...
                    <?= form_open(base_url('Regsa170efdc/add')); ?>
                      ...
                      <fieldset>
                        <legend>Adicionar um novo registro</legend> <!-- .form-group -->
							...
							<input type='text' name='a170_Reg' id='a170_Reg' class='form-control' placeholder='Registro' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='number' name='a170_NumItem' id='a170_NumItem' class='form-control' placeholder='Sequencia' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='number' name='a170_Reg0200EFDCId' id='a170_Reg0200EFDCId' class='form-control' placeholder='Código do Item' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='a170_DescricaoComplementar' id='a170_DescricaoComplementar' class='form-control' placeholder='Descrição complementar' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='' name='a170_VlItem' id='a170_VlItem' class='form-control' placeholder='Valor Total do Item' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='' name='a170_VlDesconto' id='a170_VlDesconto' class='form-control' placeholder='Valor do Desconto' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='number' name='a170_Ref431Id' id='a170_Ref431Id' class='form-control' placeholder='Código da Situação Tributária' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='number' name='a170_Ref433Id' id='a170_Ref433Id' class='form-control' placeholder='Código da Situação Tributária Referente ao PIS/Pasep' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='' name='a170_VlBcPis' id='a170_VlBcPis' class='form-control' placeholder='Valor BC PIS' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='' name='a170_VlAliqPis' id='a170_VlAliqPis' class='form-control' placeholder='Valor Alíquota do PIS' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='' name='a170_VlPis' id='a170_VlPis' class='form-control' placeholder='Valor PIS' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='number' name='a170_Ref434Id' id='a170_Ref434Id' class='form-control' placeholder='Código da Situação Tributária Referente à Cofins' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='' name='a170_VlBcCofins' id='a170_VlBcCofins' class='form-control' placeholder='Valor BC COFINS' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='' name='a170_VlAliqCofins' id='a170_VlAliqCofins' class='form-control' placeholder='Valor Alíquota do COFINS' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='' name='a170_VlCofins' id='a170_VlCofins' class='form-control' placeholder='Valor da COFINS' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='number' name='a170_Reg0500EFDCId' id='a170_Reg0500EFDCId' class='form-control' placeholder='Plano de Conta' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='number' name='a170_Reg0600EFDCId' id='a170_Reg0600EFDCId' class='form-control' placeholder='Centro de Custo' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='number' name='a170_RegA100EFDCId' id='a170_RegA100EFDCId' class='form-control' placeholder='Documento - Nota Fiscal de Serviço' value='' >
							<?php if(isset($response)): ?>
							...
							<div class='form-group'>
								<label for='a170_UsersId'>Usuários</label>
							<input type='number' name='a170_UsersId' id='a170_UsersId' class='form-control' placeholder='Usuários' value='' required>
							<?php if(isset($response)): ?>
								<div class='invalid-feedback' style='display:block'><?= isset($response['error']['a170_UsersId']) ? $response['error']['a170_UsersId'] : ''; ?></div>
							<?php endif; ?>
						</div>
