            ...
            <div class='page-section'>
              ...
              <div class='section-block'>            
                ...
                <div id='base-style' class='card'>
                  ...
                  <div class='card-body'>
                    <!-- .form -->
                    <?= form_open(base_url('Ref438/update/'.$response['data'][0]['438_Id'])); ?>
                      <!-- .fieldset -->
                      <fieldset>
                        <legend>Alteração do registro</legend> <!-- .form-group -->
							<div class='form-group'>
								<label for='438_Codigo'>Código</label>
							<input type='text' name='438_Codigo' id='438_Codigo' class='form-control' placeholder='Código' value='<?= $response['data'][0]['438_Codigo'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='438_Descricao' id='438_Descricao' class='form-control' placeholder='Descrição' value='<?= $response['data'][0]['438_Descricao'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='date' name='438_DtIni' id='438_DtIni' class='form-control' placeholder='Data Inicial' value='<?= $response['data'][0]['438_DtIni'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='date' name='438_DtFin' id='438_DtFin' class='form-control' placeholder='Data Final' value='<?= $response['data'][0]['438_DtFin'] ?>' >
							<?php if(isset($response)): ?>
...
<script>
  var url_get = '<?= base_url('ref438/get'); ?>';
