                    ...
                    <!-- .form -->
                      ...
                      <fieldset>
                        <legend>Alteração do registro</legend> <!-- .form-group -->
							...
							<input type='text' name='api_key' id='api_key' class='form-control' placeholder='' value='<?= isset($response['data'][0]['api_key']) ? $response['data'][0]['api_key'] : '' ?>' required disabled>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='controller' id='controller' class='form-control' placeholder='' value='<?= isset($response['data'][0]['controller']) ? $response['data'][0]['controller'] : '' ?>' required disabled>
							<?php if(isset($response)): ?>
							...
							<input type='date' name='date_created' id='date_created' class='form-control' placeholder='' value='<?= isset($response['data'][0]['date_created']) ? $response['data'][0]['date_created'] : '' ?>'  disabled>
							<?php if(isset($response)): ?>
							...
							<input type='date' name='date_modified' id='date_modified' class='form-control' placeholder='' value='<?= isset($response['data'][0]['date_modified']) ? $response['data'][0]['date_modified'] : '' ?>'  disabled>
							<?php if(isset($response)): ?>
