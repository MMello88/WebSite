                    ...
                    <?= form_open(base_url('Regs0100efdc/update/'.$response['data'][0]['0100_Id'])); ?>
                      ...
                      <fieldset>
                        <legend>Alteração do registro</legend> <!-- .form-group -->
							...
							<input type='number' step='1' name='0100_CPF' id='0100_CPF' class='form-control' placeholder='CPF' value='<?= $response['data'][0]['0100_CPF'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='number' step='1' name='0100_CNPJ' id='0100_CNPJ' class='form-control' placeholder='CNPJ' value='<?= $response['data'][0]['0100_CNPJ'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='number' step='1' name='0100_CEP' id='0100_CEP' class='form-control' placeholder='CEP' value='<?= $response['data'][0]['0100_CEP'] ?>' required>
							<?php if(isset($response)): ?>
