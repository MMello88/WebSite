                    ...
                    <?= form_open(base_url('Ref4314/add')); ?>
                      ...
                      <fieldset>
                        <legend>Adicionar um novo registro</legend> <!-- .form-group -->
							...
							<input type='text' name='4314_Codigo' id='4314_Codigo' class='form-control' placeholder='Código' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='4314_Descricao' id='4314_Descricao' class='form-control' placeholder='Descrição' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='date' name='4314_DtIni' id='4314_DtIni' class='form-control' placeholder='Data Inicial' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='date' name='4314_DtFin' id='4314_DtFin' class='form-control' placeholder='Data Final' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='4314_Ncm' id='4314_Ncm' class='form-control' placeholder='NCM' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='4314_NcmEx' id='4314_NcmEx' class='form-control' placeholder='Exceto NCM' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='4314_ExIpi' id='4314_ExIpi' class='form-control' placeholder='Código EX TIPI' value='' >
							<?php if(isset($response)): ?>
...
<script>
  var url_get = '<?= base_url('ref4314/create'); ?>';
