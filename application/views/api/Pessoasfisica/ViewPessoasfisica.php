                    ...
                    <!-- .form -->
                      ...
                      <fieldset>
                        <legend>Alteração do registro</legend> <!-- .form-group -->
							...
							<input type='datetime-local' name='pf_Criacao' id='pf_Criacao' class='form-control' placeholder='' value='<?= isset($response['data'][0]['pf_Criacao']) ? $response['data'][0]['pf_Criacao'] : 'CURRENT_TIMESTAMP(6)' ?>' required disabled>
							<?php if(isset($response)): ?>
