                    ...
                    <!-- .form -->
                      ...
                      <fieldset>
                        <legend>Alteração do registro</legend> <!-- .form-group -->
							...
							<input type='text'  name='pf_Nome' id='pf_Nome' class='form-control' placeholder='Nome' value='<?= isset($response['data'][0]['pf_Nome']) ? $response['data'][0]['pf_Nome'] : '' ?>' required disabled>
							<?php if(isset($response)): ?>
							...
							<input type='text'  name='pf_Sobrenome' id='pf_Sobrenome' class='form-control' placeholder='Sobrenome' value='<?= isset($response['data'][0]['pf_Sobrenome']) ? $response['data'][0]['pf_Sobrenome'] : '' ?>' required disabled>
							<?php if(isset($response)): ?>
							...
							<input type='date'  name='pf_DataNascimento' id='pf_DataNascimento' class='form-control' placeholder='Data Nascimento' value='<?= isset($response['data'][0]['pf_DataNascimento']) ? $response['data'][0]['pf_DataNascimento'] : '' ?>' required disabled>
							<?php if(isset($response)): ?>
							...
							<input type='text'  name='pf_UrlFoto' id='pf_UrlFoto' class='form-control' placeholder='Foto Perfil' value='<?= isset($response['data'][0]['pf_UrlFoto']) ? $response['data'][0]['pf_UrlFoto'] : '' ?>'  disabled>
							<?php if(isset($response)): ?>
							...
							<select name='pf_Ativo' id='pf_Ativo' class='custom-select' placeholder='Ativo' required disabled>
								<option value=''> Selecione </option>
								<option value='True' <?= isset($response['data'][0]['pf_Ativo']) ? $response['data'][0]['pf_Ativo'] == 'True' ? 'selected' : '' : '' ?>> True </option>
								<option value='False' <?= isset($response['data'][0]['pf_Ativo']) ? $response['data'][0]['pf_Ativo'] == 'False' ? 'selected' : '' : '' ?>> False </option>
							</select>
						</div>
							<div class='form-group'>
								<label for='pf_Criacao'></label>
							<input type='datetime-local'  name='pf_Criacao' id='pf_Criacao' class='form-control' placeholder='' value='<?= isset($response['data'][0]['pf_Criacao']) ? (substr($response['data'][0]['pf_Criacao'],10,1) !== 'T' ? date_format(date_create_from_format('Y-m-d H:i:s', $response['data'][0]['pf_Criacao']),'Y-m-d\TH:i') : $response['data'][0]['pf_Criacao'])  : 'CURRENT_TIMESTAMP(6)' ?>' required disabled>
							<?php if(isset($response)): ?>
