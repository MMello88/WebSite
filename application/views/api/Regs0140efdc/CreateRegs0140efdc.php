            ...
            <div class='page-section'>
              ...
              <div class='section-block'>            
                ...
                <div id='base-style' class='card'>
                  ...
                  <div class='card-body'>
                    <!-- .form -->
                    <?= form_open(base_url('Regs0140efdc/add/'.$parentView.'/'.$IdParent)); ?>
                      <!-- .fieldset -->
                      <fieldset>
                        <legend>Adicionar um novo registro</legend> <!-- .form-group -->
							...
							<input type='number' step='1' name='0140_CNPJ' id='0140_CNPJ' class='form-control' placeholder='CNPJ' value='<?= isset($response['data']['0140_CNPJ']) ? $response['data']['0140_CNPJ'] : '' ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='hidden' name='0140_MunicipioId' value='<?= $IdParent ?>' required>
