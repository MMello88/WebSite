                      ...
                      <div class='input-group-prepend'>
                        <select id='filterBy' class='custom-select'>
                          <option value='' selected> Filtrar por </option>
													<option value='0'> pf_Id </option>
													<option value='1'> pf_Nome </option>
													<option value='2'> pf_Sobrenome </option>
													<option value='3'> pf_DataNascimento </option>
													<option value='4'> pf_UrlFoto </option>
													<option value='5'> pf_Ativo </option>
													<option value='6'> pf_Criacao </option>
