                    ...
                    <?= form_open(base_url('Ref4313/add')); ?>
                      ...
                      <fieldset>
                        <legend>Adicionar um novo registro</legend> <!-- .form-group -->
							...
							<input type='text' name='4313_Codigo' id='4313_Codigo' class='form-control' placeholder='Código' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='4313_Descricao' id='4313_Descricao' class='form-control' placeholder='Descrição' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='date' name='4313_DtIni' id='4313_DtIni' class='form-control' placeholder='Data Inicial' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='date' name='4313_DtFin' id='4313_DtFin' class='form-control' placeholder='Data Final' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='4313_Ncm' id='4313_Ncm' class='form-control' placeholder='NCM' value='' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='4313_NcmEx' id='4313_NcmEx' class='form-control' placeholder='Exceto NCM' value='' >
							<?php if(isset($response)): ?>
							...
							<input type='text' name='4313_ExIpi' id='4313_ExIpi' class='form-control' placeholder='Código EX TIPI' value='' >
							<?php if(isset($response)): ?>
