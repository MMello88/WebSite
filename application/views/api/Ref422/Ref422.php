                      ...
                      <div class='input-group-prepend'>
                        <select id='filterBy' class='custom-select'>
                          <option value='' selected> Filtrar por </option>
													<option value='0'> 422_Id </option>
													<option value='1'> 422_Codigo </option>
													<option value='2'> 422_Descricao </option>
													<option value='3'> 422_DtIni </option>
													<option value='4'> 422_DtFin </option>
