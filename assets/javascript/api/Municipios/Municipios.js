...
var DTMunicipios =
function () {
  function DTMunicipios() {
    _classCallCheck(this, DTMunicipios);
    this.init();
  }

  _createClass(DTMunicipios, [{
    key: "init",
    value: function init() {
    ...
    value: function table() {
      return $('#myTableMunicipios').DataTable({
        dom: "<'text-muted'Bi>\n        <'table-responsive'tr>\n        <'mt-4'p>",
        buttons: ['copyHtml5', {
          extend: 'print', 
          autoPrint: false
        ...
        columnDefs: [{
          ...
          render: function render(data, type, row, meta) {
            ...
            <div class='custom-control custom-control-nolabel custom-checkbox'>
              <input type='checkbox' class='custom-control-input' name='selectedRow[]' id='p${row['mun_Id']}' value='${row['mun_Id']}'>
              <label class='custom-control-label' for='p${row['mun_Id']}'></label>
            </div>`;
          }
        },{
          targets: 1,
    ...
    value: function clearSelected() {
      ...
      $('#myTableMunicipios').on('page.dt', function () {
        self.clearSelectedRows();
      });
