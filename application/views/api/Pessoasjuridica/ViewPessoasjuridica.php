              ...
              <nav aria-label='breadcrumb'>
                <ol class='breadcrumb'>
                  <li class='breadcrumb-item active'>
                    <a href='<?= base_url('Pessoasfisica/'.$parentView.'/'.$IdParent) ?>'><i class='breadcrumb-icon fa fa-angle-left mr-2'></i>Voltar</a>
                  </li>
                </ol>
              </nav><!-- /.breadcrumb -->
                    ...
                    <!-- .form -->
                      ...
                      <fieldset>
                        <legend>Alteração do registro</legend> <!-- .form-group -->
							...
							<input type='number' step='1' name='pj_Matriz' id='pj_Matriz' class='form-control' placeholder='Matriz' value='<?= isset($response['data'][0]['pj_Matriz']) ? $response['data'][0]['pj_Matriz'] : '0' ?>' required disabled>
							<?php if(isset($response)): ?>
							...
							<input type='number' step='1' name='pj_NaturezaJuridica' id='pj_NaturezaJuridica' class='form-control' placeholder='Natureza Juridica' value='<?= isset($response['data'][0]['pj_NaturezaJuridica']) ? $response['data'][0]['pj_NaturezaJuridica'] : '' ?>' required disabled>
							<?php if(isset($response)): ?>
							...
							<input type='number' step='1' name='pj_DmContribuicao' id='pj_DmContribuicao' class='form-control' placeholder='Contribuinte' value='<?= isset($response['data'][0]['pj_DmContribuicao']) ? $response['data'][0]['pj_DmContribuicao'] : '0' ?>' required disabled>
							<?php if(isset($response)): ?>
