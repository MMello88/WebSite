            ...
            <div class='page-section'>
              ...
              <div class='section-block'>            
                ...
                <div id='base-style' class='card'>
                  ...
                  <div class='card-body'>
                    <!-- .form -->
                    <?= form_open(base_url('Regs0145efdc/update/'.$response['data'][0]['0145_Id'])); ?>
                      <!-- .fieldset -->
                      <fieldset>
                        <legend>Alteração do registro</legend> <!-- .form-group -->
							<div class='form-group'>
								<label for='0145_Reg'>Registro</label>
							<input type='text'  name='0145_Reg' id='0145_Reg' class='form-control' placeholder='Registro' value='<?= $response['data'][0]['0145_Reg'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='number' step='1' name='0145_CodIncTrib' id='0145_CodIncTrib' class='form-control' placeholder='Código Incidência Tributária' value='<?= $response['data'][0]['0145_CodIncTrib'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='number' step='0.01' name='0145_VlRecTot' id='0145_VlRecTot' class='form-control' placeholder='Valor da Receita Bruta Total' value='<?= $response['data'][0]['0145_VlRecTot'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='number' step='0.01' name='0145_VlRecAtiv' id='0145_VlRecAtiv' class='form-control' placeholder='Valor da Receita Bruta da Atividade' value='<?= $response['data'][0]['0145_VlRecAtiv'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='number' step='0.01' name='0145_VlRecDemaisAtiv' id='0145_VlRecDemaisAtiv' class='form-control' placeholder='Valor da Receita Bruta das demais Atividade' value='<?= $response['data'][0]['0145_VlRecDemaisAtiv'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='text'  name='0145_InfoCompl' id='0145_InfoCompl' class='form-control' placeholder='Informação complementar' value='<?= $response['data'][0]['0145_InfoCompl'] ?>' >
							<?php if(isset($response)): ?>
