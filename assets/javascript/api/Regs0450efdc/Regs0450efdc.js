...
var DTRegs0450efdc =
function () {
  function DTRegs0450efdc() {
    _classCallCheck(this, DTRegs0450efdc);
    this.init();
  }

  _createClass(DTRegs0450efdc, [{
    key: "init",
    value: function init() {
    ...
    value: function table() {
      return $('#myTableRegs0450efdc').DataTable({
        dom: "<'text-muted'Bi>\n        <'table-responsive'tr>\n        <'mt-4'p>",
        buttons: ['copyHtml5', {
          extend: 'print', 
          autoPrint: false
        ...
        columnDefs: [{
          ...
          render: function render(data, type, row, meta) {
            ...
            <div class='custom-control custom-control-nolabel custom-checkbox'>
              <input type='checkbox' class='custom-control-input' name='selectedRow[]' id='p${row['0450_Id']}' value='${row['0450_Id']}'>
              <label class='custom-control-label' for='p${row['0450_Id']}'></label>
            </div>`;
          }
        },{
          targets: 1,
    ...
    value: function clearSelected() {
      ...
      $('#myTableRegs0450efdc').on('page.dt', function () {
        self.clearSelectedRows();
      });
