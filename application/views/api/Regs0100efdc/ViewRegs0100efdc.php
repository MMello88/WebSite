                    ...
                    <!-- .form -->
                      ...
                      <fieldset>
                        <legend>Alteração do registro</legend> <!-- .form-group -->
							...
							<input type='number' name='0100_CPF' id='0100_CPF' class='form-control' placeholder='CPF' value='<?= isset($response['data'][0]['0100_CPF']) ? $response['data'][0]['0100_CPF'] : '' ?>' required disabled>
							<?php if(isset($response)): ?>
							...
							<input type='number' name='0100_CNPJ' id='0100_CNPJ' class='form-control' placeholder='CNPJ' value='<?= isset($response['data'][0]['0100_CNPJ']) ? $response['data'][0]['0100_CNPJ'] : '' ?>' required disabled>
							<?php if(isset($response)): ?>
							...
							<input type='number' name='0100_CEP' id='0100_CEP' class='form-control' placeholder='CEP' value='<?= isset($response['data'][0]['0100_CEP']) ? $response['data'][0]['0100_CEP'] : '' ?>' required disabled>
							<?php if(isset($response)): ?>
