            ...
            <div class='page-section'>
              ...
              <div class='section-block'>            
                ...
                <div id='base-style' class='card'>
                  ...
                  <div class='card-body'>
                    <!-- .form -->
                    <?= form_open(base_url('Ref432/add')); ?>
                      <!-- .fieldset -->
                      <fieldset>
                        <legend>Adicionar um novo registro</legend> <!-- .form-group -->
							<div class='form-group'>
								<label for='432_Codigo'>Código</label>
							<input type='text' name='432_Codigo' id='432_Codigo' class='form-control' placeholder='Código' value='<?= isset($response['data']['432_Codigo']) ? $response['data']['432_Codigo'] : '' ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='text' name='432_Descricao' id='432_Descricao' class='form-control' placeholder='Descrição' value='<?= isset($response['data']['432_Descricao']) ? $response['data']['432_Descricao'] : '' ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='date' name='432_DtIni' id='432_DtIni' class='form-control' placeholder='Data Inicial' value='<?= isset($response['data']['432_DtIni']) ? $response['data']['432_DtIni'] : '' ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='date' name='432_DtFin' id='432_DtFin' class='form-control' placeholder='Data Final' value='<?= isset($response['data']['432_DtFin']) ? $response['data']['432_DtFin'] : '' ?>' >
							<?php if(isset($response)): ?>
...
<script>
  var url_get = '<?= base_url('ref432/create'); ?>';
  var url_upd = '<?= base_url('ref432/edit'); ?>';
  var url_view = '<?= base_url('ref432/view'); ?>';
</script>
