                      ...
                      <div class='input-group-prepend'>
                        <select id='filterBy' class='custom-select'>
                          <option value='' selected> Filtrar por </option>
													<option value='0'> 437_Id </option>
													<option value='1'> 437_Codigo </option>
													<option value='2'> 437_Descricao </option>
													<option value='3'> 437_DtIni </option>
													<option value='4'> 437_DtFin </option>
