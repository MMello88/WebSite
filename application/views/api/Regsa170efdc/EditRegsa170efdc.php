                    ...
                    <?= form_open(base_url('Regsa170efdc/update/'.$response['data'][0]['a170_Id'])); ?>
                      ...
                      <fieldset>
                        <legend>Alteração do registro</legend> <!-- .form-group -->
							...
							<input type='number' name='a170_NumItem' id='a170_NumItem' class='form-control' placeholder='Sequencia' value='<?= $response['data'][0]['a170_NumItem'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='' name='a170_VlItem' id='a170_VlItem' class='form-control' placeholder='Valor Total do Item' value='<?= $response['data'][0]['a170_VlItem'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='' name='a170_VlDesconto' id='a170_VlDesconto' class='form-control' placeholder='Valor do Desconto' value='<?= $response['data'][0]['a170_VlDesconto'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='' name='a170_VlBcPis' id='a170_VlBcPis' class='form-control' placeholder='Valor BC PIS' value='<?= $response['data'][0]['a170_VlBcPis'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='' name='a170_VlAliqPis' id='a170_VlAliqPis' class='form-control' placeholder='Valor Alíquota do PIS' value='<?= $response['data'][0]['a170_VlAliqPis'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='' name='a170_VlPis' id='a170_VlPis' class='form-control' placeholder='Valor PIS' value='<?= $response['data'][0]['a170_VlPis'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='' name='a170_VlBcCofins' id='a170_VlBcCofins' class='form-control' placeholder='Valor BC COFINS' value='<?= $response['data'][0]['a170_VlBcCofins'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='' name='a170_VlAliqCofins' id='a170_VlAliqCofins' class='form-control' placeholder='Valor Alíquota do COFINS' value='<?= $response['data'][0]['a170_VlAliqCofins'] ?>' required>
							<?php if(isset($response)): ?>
							...
							<input type='' name='a170_VlCofins' id='a170_VlCofins' class='form-control' placeholder='Valor da COFINS' value='<?= $response['data'][0]['a170_VlCofins'] ?>' required>
							<?php if(isset($response)): ?>
