                      ...
                      <div class='input-group-prepend'>
                        <select id='filterBy' class='custom-select'>
                          <option value='' selected> Filtrar por </option>
													<option value='0'> 434_Id </option>
													<option value='1'> 434_Codigo </option>
													<option value='2'> 434_Descricao </option>
													<option value='3'> 434_DtIni </option>
													<option value='4'> 434_DtFin </option>
