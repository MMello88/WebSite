...
function () {
  ...
  _createClass(DTPai, [{
        ...
        columnDefs: [{
          ...
          render: function render(data, type, row, meta) {
            ...
            <div class='custom-control custom-control-nolabel custom-checkbox'>
              <input type='checkbox' class='custom-control-input' name='selectedRow[]' id='p${row['pp_Id']}' value='${row['pp_Id']}'>
              <label class='custom-control-label' for='p${row['pp_Id']}'></label>
            </div>`;
          }
        },{
          targets: 1,
    ...
    value: function clearSelected() {
      ...
      $('#myTablePai').on('page.dt', function () {
        self.clearSelectedRows();
      });
